      ...
      init: function() {
        if (!/baiduinput/gi.test(window.navigator.userAgent)) {
          ...
          _hmt.push(["_trackEvent", "首页", "首页app导流浮层展现量"]),
            ...
            n.setCookie(a, "1", { expires: 5184e6 }),
            this.bindEvent();
        }
      },
      bindEvent: function() {
...
define("translation:widget/translate/common/hash", function(t, e, n) {
  ...
  (c.set = function(t, e, n) {
    ...
    (c.get = function() {
      ...
      if (((n = n.replace(/^\#/, "")), n.indexOf("/") > 0))
        (t = n.split("/")),
          (e =
            t.length > 3
              ? { from: t[0], to: t[1], query: t.splice(0, 2) && t.join("/") }
              : 3 === t.length
              ? { from: t[0], to: t[1], query: t[2] }
              : 2 === t.length
              ? { from: t[0], to: t[1], query: "" }
              : 1 === t.length
              ? { from: t[0], to: "", query: "" }
              : !1);
...
define("translation:widget/translate/details/adLink/adLink", function(n, i, t) {
  "use strict";
  function a() {
    window.adLinkInfo.isShowAdLink &&
      (_hmt.push(["_trackEvent", "首页", "web端中部文字链广告展现"]), o());
  }
  function o() {
  ...
  function d(n) {
    var i = s(
      "tplAdLink",
      Object.assign(window.adLinkInfo, { isPlaceAdLinkRight: n })
    );
    l.append(i);
  }
  function e() {
  ...
  function c() {
    var n = s(
      "tplAdLink",
      Object.assign(window.adLinkInfo, { isPlaceAdLinkRight: !1 })
    );
    k.html(n), k.show();
  }
  function r() {
...
define("translation:widget/translate/sideNav/navSorter/listOperator", function(
  t,
  i,
  n
) {
    ...
    c = {
      ...
      initNavList: function() {
        ...
        if (t.length > 0 && n.is_login) {
          var e = r(t, i);
          return (
            e.hasDiff && ((t = e.targetList), this.setOwnerList(t)),
            this.setLocalList(t),
            (a = t),
            t
          );
      ...
      setNavList: function(t) {
        var i = this,
          n = s.get("account");
        return n.is_login
          ? this.setOwnerList(t).then(function() {
      ...
      getDefaultList: function() {
        return (
          u ||
            (u = this.listStrToArr(window.common.defaultNavList).filter(
              function(t) {
                return null != o[t];
              }
            )),
      ...
      getLocalList: function() {
        return e.supportLocalStorage
          ? this.listStrToArr(localStorage.getItem("FY_NAV_LIST"))
          : [];
      },
...
define("translation:widget/translate/sideNav/navSorter/ListDrag", function(
  t,
  e,
  r
) {
        ...
        n(t, [
          {
            key: "init",
            value: function(t) {
              (this.handlers = { dragStart: [], dragMove: [], dragEnd: [] }),
                (this.isDragging = !1),
                ...
                (this.$outWrapper = this.hasOutWrapper
                  ? $(t.$outWrapper)
                  : this.$container),
                (this.bound = {}),
              ...
              this.$container.on(
                ...
                function(e) {
                  if (0 === e.button) {
                    ...
                    if (
                      (t.$dragTarget
                        .addClass(t.itemClassName + "-dragging")
                        .css({ left: a, top: n })
                        .before(t.$holdDom)
                        .attr("data-sortable", "n"),
                      (t.$sortableItems = t.$container.find(
                        '[data-sortable="y"]'
                      )),
                      $.each(t.$sortableItems, function(e, r) {
                        return $(r).hasClass("nav-st-item-hold")
                          ? ((t.holdIdx = e), !1)
                          : void 0;
                      }),
                      t.hasOutWrapper)
                    ...
                    t.trigger("dragStart"),
                      $(document).on("mousemove.listDrag", function(e) {
                        if (t.isDragging) {
                          ...
                          (r = Math.min(
                            Math.max(t.bound.l, r),
                            t.bound.l + t.bound.w - t.dragTargetW
                          )),
                            (a = Math.min(
                              Math.max(t.bound.t, a),
                              t.bound.t + t.bound.h - t.dragTargetH
                            ));
                          var n = r - t.containerOffset.left,
                            o = a - t.containerOffset.top;
                          t.$dragTarget.css({ left: n, top: o });
                          var i = Math.min(
                              Math.max(o + t.dragTargetH / 2, 0),
                              t.containerH
                            ),
                            s = Math.floor(i / (t.dragTargetH + 4));
                          t.holdIdx !== s &&
                            (t.holdIdx > s
                              ? t.$sortableItems.eq(s).before(t.$holdDom)
                              : t.$sortableItems.eq(s).after(t.$holdDom),
                            (t.$sortableItems = t.$container.find(
                              '[data-sortable="y"]'
                            )),
                            (t.holdIdx = s),
                ...
                $(document).on("mouseup.listDrag", function(e) {
                  ...
                  if (t.isDragging) {
                    (t.isDragging = !1),
                      ...
                      t.$dragTarget
                        .removeAttr("style")
                        .removeClass(t.itemClassName + "-dragging")
                        .attr("data-sortable", "y"),
          ...
          { key: "destory", value: function() {} },
          {
            ...
            value: function(t, e) {
              o.includes(t) &&
                "[object Function]" !== !Object.prototype.toString(e) &&
          ...
          },
          {
            ...
            value: function(t, e) {
              var r = this;
              this.handlers[t] &&
                0 !== this.handlers[t].length &&
                this.handlers[t].forEach(function(t) {
                  t.call(r, e);
                });
            }
          }
  ...
  var e = $("#overall-toast"),
    ...
    i = {
      show: function(t, a) {
        (a = a || 1),
          e.find("span").text(t),
          e.hasClass("overall-toast-hide") &&
            e.removeClass("overall-toast-hide");
        var s = -e.width() / 2;
        e.css("margin-left", s),
          o && clearTimeout(o),
...
define("translation:widget/translate/sideNav/navSorter/navSorter", function(
  t,
  n,
  i
) {
    ...
    v = {
      ...
      initDrag: function() {
        u ||
          ((u = new s({
            holdHtml:
              '<div class="nav-st-item nav-st-item-hold" data-sortable="y"></div>',
            $outWrapper: r,
            $container: l,
      ...
      on: function(t, n) {
        h.includes(t) &&
          "[object Function]" !== !Object.prototype.toString(n) &&
  ...
  var n = t("translation:widget/common/third_party/template"),
    ...
    x = {
      ...
      locateTab: function() {
        ...
        if (t) {
          var e = $(".nav-item, .nav-sub-item").filter(
            "[data-stat-add='" + t + "']"
          );
          e.length > 0 &&
            (x.scrollToSection(parseInt(e.attr("data-section-idx"), 10)),
            window._hmt.push([
              "_trackEvent",
              "首页",
              "37_首页页面_点击目录项_" + t
        ...
        if (!w && !g) {
          ...
          o.removeClass("active").removeClass("in-view"),
            m.forEach(function(t, s) {
              var r =
                (t.topOffset >= e && t.topOffset <= a) ||
                (t.bottomOffset > e && t.bottomOffset <= a) ||
                (t.topOffset < e && t.bottomOffset > a);
              if (r) {
...
define("translation:widget/translate/details/collapse/collapse", function(
  a,
  t,
  e
) {
    ...
    n = {
          ...
          if (t.hasClass("to-expand")) {
            if (
              ...
              window._hmt.push([
                "_trackEvent",
                "首页",
                "78_首页页面_点击展开收起模块_" + l + "_展开"
              ]);
            }
          } else if (
            t.hasClass("to-collapse") &&
            (window._hmt.push([
              "_trackEvent",
              "首页",
              "47_首页页面_点击展开收起模块_" + e + "_收起"
            ]),
            ...
            window._hmt.push([
              "_trackEvent",
              "首页",
              "78_首页页面_点击展开收起模块_" + i + "_收起"
            ]);
          }
        }),
          $(window).on("resize.reGenSampleCollapse", function() {
            $(".sample-section.need-collapse").length > 0 &&
              n.setSampleCollapse(!0);
          });
      },
      expandSection: function(a, t) {
        if (a.hasClass("need-collapse")) {
          ...
          if (
            (a.hasClass("sample-section") &&
              a.attr("data-last-collapse-status", "to-collapse"),
      ...
      collapseSection: function(a, t) {
        if (a.hasClass("need-collapse") && a.hasClass("to-collapse")) {
          var e = void 0,
            l = void 0;
          t.attr("data-expand-top")
            ? ((e = parseInt(t.attr("data-expand-top"), 10)), (l = !0))
            : ((e = t.offset().top - $(window).scrollTop()), (l = !1));
          ...
          a.removeClass("to-collapse").addClass("to-expand"),
            ...
            a.hasClass("sample-section") &&
              a.attr("data-last-collapse-status", "to-expand"),
            a.hasClass("usecase-section") &&
              $(".oxford-items").length > 0 &&
              ($(".oxford-items").addClass("hide"),
      ...
      genCollapse: function() {
        ...
        a.length > 0 &&
          a.each(function() {
            ...
            if (
              ($(
                '<a class="section-collapse-expand-btn" href="javascript:"></a>'
              ).appendTo(a),
      ...
      setSampleCollapse: function(a) {
        ...
        var l = !1,
          o = null;
        e.find(".double-sample").length > 0
          ? (o = e.find(".double-sample ol > li"))
          : e.find(".single-sample") && (o = e.find(".single-sample ol > li"));
        var n = null;
        if ((o.length > 5 && ((l = !0), (n = o.eq(5))), l)) {
          var i = n.offset().top - e.offset().top;
          t.attr("data-collapse-height", i),
            "to-expand" === t.attr("data-last-collapse-status")
              ? (t.addClass("to-expand"), e.css("max-height", i + "px"))
              : "to-collapse" === t.attr("data-last-collapse-status")
              ? (t.addClass("to-collapse"), e.css("max-height", "none"))
              : (t.addClass("to-expand"),
                t.attr("data-last-collapse-status", "to-expand"),
                e.css("max-height", i + "px"));
        } else
          t.removeClass("to-collapse to-expand"), e.css("max-height", "none");
        a && s.setupPos();
      }
    };
  ...
  var i = (t("translation:widget/common/environment"),
  {
    ...
    isover: function(t) {
      var e,
        ...
        v = 0,
        h = 14;
      i.parents(".sample-output").length > 0 ||
        i.parents("#zonedword-wrap").length > 0 ||
        ((this.overTarget = t.target),
        (this.isOverFlag = !0),
        l &&
          ((e = l.split("|")),
          2 === e.length
            ? ((v = parseInt(e[0], 10)), (h = parseInt(e[1], 10)))
            : 1 === e.length && (v = parseInt(e[0], 10))),
        a
          .show()
        ...
        a
          ...
          .show(),
        (i.hasClass("setting-btn") || i.hasClass("collection-btn")) &&
          $("#hover-tips").css("top", -75));
    },
    isout: function() {
      $("#hover-tips")
        .find(".tips-content")
        .text(""),
        $("#hover-tips").offset({ left: -9999, top: -9999 }),
        (this.isOverFlag = !1),
...
define("translation:widget/translate/details/dictionary/simplemeans", function(
  t,
  e
) {
  "use strict";
  var a = t("translation:widget/common/third_party/template"),
    n = t("translation:widget/common/soundURIGenerator"),
    ...
    d = {
      buildSimpleMeans: function(t) {
        ...
        if (
          ...
          var d = [];
          e.tags.core &&
            e.tags.core.length > 0 &&
            "" !== e.tags.core[0] &&
            (d = d.concat(e.tags.core)),
            e.tags.other &&
              e.tags.other.length > 0 &&
              "" !== e.tags.other[0] &&
              (d = d.concat(e.tags.other)),
            d.length > 0 && ((d = d.slice(0, 6)), (s.tplData.coreTags = d));
        }
        if (e.exchange) for (var h in e.exchange) e.exchange[h] && (c = !0);
        (s.tplData.showExchange = c),
          "zh" === u &&
            "en" === p &&
            ((s.tplData.isZh2En = !0),
            _hmt.push(["_trackEvent", "首页", "Web中英词典释义卡片展现次数"])),
          s.tplData.symbols
            ? ((s.tplData.baikeImgUrl = n),
              (s.tplData.isFirstCard = o),
              (r = a("tplSimplemeans", s)),
              n &&
                _hmt.push([
                  "_trackEvent",
                  "首页",
                  "64_首页页面_Web词典释义卡片_图片展现次数"
                ]),
              e.memory_skill &&
                _hmt.push([
                  "_trackEvent",
                  "首页",
                  "73_首页页面_Web词典释义卡片_记忆技巧展现次数"
                ]),
              e.derivative &&
                _hmt.push([
                  "_trackEvent",
                  "首页",
                  "80_首页页面_Web词典释义卡片_派生词展现次数"
                ]))
            : s.tplData.content && (r = a("tplOtherSimplemeans", s)),
          l.find(".dictionary-wrap").html(r),
          "英" !==
            $(".phonetic-transcription span")
              .eq(0)
              .text() && $(".simple-dict").addClass("simple-dict-ztoe"),
          $(".simple-dict .op-repeat").length > 0 &&
            (_hmt.push(["_trackEvent", "首页", "web端复读按钮出现次数"]),
            this.bindRepeatEvents()),
          _hmt.push(["_trackEvent", "首页", "web端词典卡片出现次数"]);
      },
      bindEvents: function() {
        var t = this;
        $(".translate-wrap")
          .on("click", ".dictionary-wrap .op-sound", function() {
          ...
          .off("click.sound")
          .on("click.sound", "a", function() {
            var e = $(this);
            (e.attr("href").match(/[\.\/]/g) || e.hasClass("collection-btn")) &&
              t.shutdownAudio();
          });
      },
      ...
      repeatSound: function(t) {
        var e = this,
          a = $(t.target);
        if (a.hasClass("op-repeat-running"))
          o.isover({ target: t.target, text: "复读" }),
            e.shutdownRepeat(),
          ...
          if (
            ...
            BTPM.setUrl(u),
            c--,
            o.isover({ target: t.target, text: "停止复读" }),
            a.attr("data-hover-tip-text", "停止复读"),
            "IE" === BTPM.stage)
          ) {
            ...
            if (i && i.length > 0) {
              ...
              r = setInterval(function() {
                return 1 > c
                  ? void e.shutdownRepeat()
                  : (BTPM.setUrl(u), void c--);
              }, l);
            }
          } else
            (p = !0),
      ...
      shutdownRepeat: function(t) {
        $(".op-repeat")
          .removeClass("op-repeat-running")
          .attr("data-hover-tip-text", "复读"),
          (t && t.nopause) || BTPM.doPause(),
          "IE" === BTPM.stage
            ? clearInterval(r)
            : (clearTimeout(s), (p = !1), $(BTPM).off("ended.repeating"));
      },
      ...
      bindRepeatEvents: function() {
        var t = this;
        $(".container")
          .off("click.repeatthing")
          .on("click.repeatthing", "a", function() {
            var e = $(this);
            $(".op-repeat").hasClass("op-repeat-running") &&
              !e.hasClass("op-repeat") &&
              ((e.attr("href").match(/[\.\/]/g) ||
                e.hasClass("collection-btn")) &&
                t.shutdownRepeat(),
              _hmt.push(["_trackEvent", "首页", "web端其他方式停止复读"]));
          });
      },
      judgeStopRepeat: function() {
        this.isNotInRepeating() ||
          (this.shutdownRepeat({ nopause: !0 }),
          _hmt.push(["_trackEvent", "首页", "web端发音按钮停止复读"]));
      },
      translateStopRepeat: function() {
        return this.isNotInRepeating()
          ? !1
          : (this.shutdownRepeat(),
      ...
      isNotInRepeating: function() {
        return (
          !$(".op-repeat") || !$(".op-repeat").hasClass("op-repeat-running")
        );
      },
...
define("translation:widget/translate/details/collins/collins", function(t, e) {
  ...
  function n(t) {
    return "mean" === t.type &&
      t.value &&
      t.value.length > 0 &&
      (t.value[0].mean_type.length > 0 || t.value[0].def)
      ? !0
      : !1;
  }
  ...
  var r = {
    buildCollins: function(t) {
      var e = t.data,
        a = {};
      if (e.menus)
        for (var o = e.menus.length, r = 0; o > r; r++) {
          var l = e.menus[r];
          if (l.entry)
    ...
    bindEvents: function() {
      var t = this;
      $(".translate-wrap")
        .on("click", ".collins-item .op-sound", function() {
...
define("translation:widget/translate/output/adcards", function(a, t) {
  "use strict";
  var e,
    r = (a("translation:widget/common/environment"),
    a("translation:widget/common/third_party/template")),
    n = a("translation:widget/common/cookie"),
    p = {
      bindEvents: function() {
        $(".translate-wrap").on("click", ".trans-ad-app-control", function() {
          var a = $(".trans-ad-app-wrap").hasClass("trans-ad-app-wrap-click")
            ? 1
            : 0;
          $(".trans-ad-app-wrap").toggleClass("trans-ad-app-wrap-click"),
            _hmt.push(["_trackEvent", "首页", "web端二维码点击"]),
            0 === a &&
              _hmt.push(["_trackEvent", "首页", "web端收拢APP二维码点击"]),
            1 === a &&
              _hmt.push(["_trackEvent", "首页", "web端展开APP二维码点击"]);
        }),
          $("#sideAdData").length > 0
            ? ((e = "sideAd"),
              $(".translate-wrap")
                .on("click", ".showad-close-btn", function(a) {
      ...
      hideAppQr: function() {
        "appAd" === e
          ...
          : "sideAd" === e && $(".trans-side-ad-wrap").hide();
      },
      showAppQr: function(a) {
        if (
          $(".app-guide").length > 0 &&
          !$(".app-guide").hasClass("app-guide-hide")
        )
        ...
        if ("appAd" === e) {
          ...
          if (
            $(".trans-side-ad-wrap").length > 0 &&
            "block" === $(".trans-side-ad-wrap").css("display")
          )
            return;
        ...
        $(".trans-ad-app-wrap, .trans-side-ad-wrap").toggleClass(
          "hot-link-middle-right",
          a
        );
      }
    };
...
define("translation:widget/translate/details/translator/translator", function(
  t,
  n,
  e
) {
  ...
  var a = t("translation:widget/common/third_party/template"),
    ...
    u = {
      ...
      build: function(t) {
        var n = 0 === parseInt(r.get("firstModuleId"), 10),
          e = "",
          o = t || {};
        (o.jd = o.jdweb ? o.jdweb : ""),
          (o.img = o.imgweb ? o.imgweb : ""),
          (o.isFirstCard = n),
          (e = a("tplTranslator", { tplData: o })),
          s.append(e),
          window._hmt.push([
            "_trackEvent",
            "首页",
...
define("translation:widget/translate/details/festivalLink/festivalLink", function(
  t,
  n,
  i
) {
...
define("translation:widget/translate/details/edict/edict", function(t, e, n) {
  ...
  var i = t("translation:widget/common/third_party/template"),
    ...
    u = {
      bindEvents: function() {
        $(".translate-wrap")
          .on("click", ".item-edict .op-sound", function(t) {
...
define("translation:widget/translate/details/zdict/zdict", function(t, a, e) {
  ...
  function i(t) {
    ...
    (e.tplData = {}),
      ...
      a.simple
        ? (e.tplData.simple = a.simple)
        : a.detail && a.detail.chenyu
        ? (e.tplData.chenyu = a.detail.chenyu)
        : a.detail && a.detail.means && (e.tplData.simple = a.detail);
  ...
  var n = t("translation:widget/common/third_party/template"),
    ...
    o = {
      ...
      bindEvent: function() {
        var t = this;
        $(".translate-wrap")
          .on("click", ".keywords-inner .keywords-word", function() {
            var t = $(this).attr("data-direction");
            _hmt.push(
              "zh2en" === t
                ? ["_trackEvent", "首页", "Web中英方向重点词汇二次翻译次数"]
                : ["_trackEvent", "首页", "Web英中方向重点词汇二次翻译次数"]
            );
          })
        ...
        $(window).on("scroll", function() {
          ...
          if (!($(".spread-slide a").length <= 0 || n === t.get("preHash"))) {
            var e = $(window).height(),
              ...
              r = $(window).scrollTop();
            e + r > a &&
              ($(".dictionary-wrap").length > 0 ||
                $(".output-detaildict-tab").children().length > 1) &&
              (_hmt.push([
                "_trackEvent",
                "web端翻译—banner总展现",
                "web端翻译—非首屏banner展现"
  ...
  var t = {
    ...
    parseDictResult: function() {
      ...
      return (
        r.each(function() {
          (e += $(this)
            .find(".dictionary-title")
            .html()),
            (e += $(this)
              .find(".dictionary-comment")
              .html());
        }),
        (e = e
          .replace(/<(?!\/(div|p))[^<>]*>/gi, "")
...
define("translation:widget/translate/input/inputCollGroup/inputCollGroup", function(
  n,
  o,
  t
) {
        ...
        $(document).on("click", function(n) {
          ...
          p.on("input", function() {
            $(this).val() || $(this)[0].value
              ? s.removeClass("disabled-new-group-confirm")
              : s.addClass("disabled-new-group-confirm");
          }),
          s.on("click", y.newGroupAndAddColl),
          p.keydown(function(n) {
            return 13 === parseInt(n.keyCode, 10)
              ? (n.preventDefault(), y.newGroupAndAddColl(), !1)
              : void 0;
          }),
          h.on("click", function() {
            y.hide();
      ...
      newGroupAndAddColl: function() {
        if (!s.hasClass("disabled-new-group-confirm")) {
          _hmt.push([
            "_trackEvent",
            "首页",
            "19_首页页面_输入框收藏分组创建并添加按钮点击"
          ]);
          var n = p.val() || p[0].value;
          r.newCollGroupAsync(n, !1).then(
            function(o) {
              l
                .get("collInfo")
                .groupList.push({ name: n, id: o, nameDisplayLegth: a(n) }),
...
define("translation:widget/translate/zonedword/zonedCollGroup/zonedCollGroup", function(
  o,
  n,
  t
) {
...
define("translation:widget/translate/favo/favo", function(t, e, i) {
  ...
  var o = t("translation:widget/login/login"),
    ...
    u = t(
      "translation:widget/translate/zonedword/zonedCollGroup/zonedCollGroup"
    );
  (n.prototype = {
    constructor: n,
    init: function(t) {
    ...
    bindEvent: function() {
      ...
      this.$btn.on("click.favo", function() {
        ...
        "" !== e.is_login
          ? (t.saved
              ? t.deleteItem()
              : c.getDefaultGroupAsync().then(function() {
                  ...
                  -1 !== e.defaultId
                    ...
                    : "zonedword" === t.pos &&
                      "none" ===
                        $(".zoned-coll-extra-container").css("display") &&
                      u.show();
                }),
            !e.add_name &&
              window.confirm("嗨，你的账户需要先添加个名字喔!") &&
              window.open("https://passport.baidu.com/v2/?ucenteradduname"))
    ...
    favorIsSaved: function(t) {
      if (this.query === t.reqQurey && this.direction === t.reqDirection) {
        ...
        i ||
          (e.attr("data-hover-tip-text", "已收藏"),
          r.isover({ target: e[0] }),
          setTimeout(function() {
            r.isout();
          }, 2e3)),
          e
            .attr({ "data-hover-tip-text": "取消收藏", title: "取消收藏" })
    ...
    favorIsNotSaved: function(t) {
      if (this.query === t.reqQurey && this.direction === t.reqDirection) {
        ...
        e
          ...
          .removeClass("op-favo-cur"),
          t.firstScreen &&
            (e.attr("data-hover-tip-text", "已取消收藏"),
            r.isover({ target: e[0] }),
            setTimeout(function() {
    ...
    add: function(t) {
      ...
      "input" === this.pos
        ? ((e.fanyi_dst = a.parseNormalResult()),
          (e.dict = this.dictJSON ? a.parseDictResult() : ""),
          (e.dict_json = this.dictJSON))
        : ((e.type = this.type),
      ...
      _hmt.push(
        "input" === this.pos
          ? ["_trackEvent", "首页", "web端输入框收藏结果点击次数"]
          : ["_trackEvent", "首页", "web端划词框收藏结果点击次数"]
      );
      var n = this;
      !(function(t, i) {
        $.ajax({
          ...
          success: function(e) {
            0 === e.errno
              ? (n.favorIsSaved({ id: e.id, reqQurey: t, reqDirection: i }),
                "input" === n.pos
                  ? d.hide()
                  : "zonedword" === n.pos && u.hide(),
                n.trigger("change"))
              : n.favorIsNotSaved({ reqQurey: t, reqDirection: i });
          }
        });
      })(this.query, this.direction);
    },
    deleteItem: function() {
      if (void 0 !== this.id && null !== this.id) {
        _hmt.push(
          "input" === this.pos
            ? ["_trackEvent", "首页", "web端输入框取消收藏点击次数"]
...
define("translation:widget/translate/details/sample/sample", function(t, e) {
  ...
  var a,
    ...
    l,
    i,
    s = t("translation:widget/common/third_party/template"),
    ...
    c = {
      ...
      getDoubleSample: function(t, e) {
        ...
        for (var l = !0, i = 0, s = a["double"].length; s > i; i++) {
          ...
          for (var u = 0, g = o.length; g > u; u++)
            (r += o[u][0]), o[u][4] && (r += o[u][4]);
          (r = encodeURIComponent(r)),
            (a.senData[i] = r),
            l &&
              $.inArray(a["double"][i][2], p) < 0 &&
              ((a["double"][i].isFirstNetSt = !0), (l = !1));
          var d = a["double"][i][2];
          if (/^https?\:\/\//.test(d)) {
            d = d.replace(/^https?\:\/\//, "");
            var c = d.indexOf("/");
            ...
            (a["double"][i][3] = a["double"][i][2]), (a["double"][i][2] = "#");
        }
        return a;
      },
      bindEvents: function() {
        var t = this;
        $(".translate-wrap")
          .on("click", ".item-sample .op-sound", function() {
            t.clickSound({ target: this });
          })
      ...
      mouseOverHighlight: function(t) {
        ...
        if ("" !== a) {
          ...
          n.find("span").each(function() {
            $(this).attr("high-light-id") === a &&
              $(this).addClass("high-light-bg");
          });
        }
      },
      ...
      clickTagItem: function(t) {
        ...
        if (!e.hasClass("sample-current")) {
          e.addClass("sample-current")
            .siblings()
            .removeClass("sample-current");
      ...
      getTagSampleDataAndRender: function(t, e) {
        var l = this,
          o = { from: a, to: n, query: i, stTag: t.tag };
        $.ajax({
          url: "/transextra",
          data: o,
          type: "POST",
...
define("translation:widget/translate/details/zhenDict/zhenDict", function(
  t,
  a,
  e
) {
...
define("translation:widget/translate/details/general/general", function(
  a,
  t,
  e
) {
  ...
  function i(a) {
    ...
    if (t) {
      ...
      r.each(function() {
        ...
        var t = a.find("a");
        n.push(t.width()),
          t.text().toLowerCase() === i.toLowerCase() &&
...
define("translation:widget/translate/details/webMeans/webMeans", function(
  t,
  e
) {
  "use strict";
...
define("translation:widget/translate/details/oxford/oxfordEntryAdapter", function(
  t,
  n,
  a
) {
...
define("translation:widget/translate/details/oxford/oxfordUnboxAdapter", function(
  a,
  t,
  o
) {
  ...
  var n = {
    init: function(a, t) {
      ...
      var o = {
        ...
        n = [
          { type: "which_word", data: [] },
          { type: "vocab", data: [] },
          { type: "british_american", data: [] },
          { type: "grammar", data: [] },
          { type: "more_about", data: [] }
        ];
...
define("translation:widget/translate/details/oxford/oxfordTemplateHelper", function(
  t
) {
  "use strict";
  ...
  var d = $("#left-result-container"),
    u = {
      ...
      bindEvents: function() {
        var t = this;
        $(".translate-wrap")
          .on("click", ".item-oxford .op-sound", function(e) {
...
define("translation:widget/translate/details/synonym/synonym", function(
  t,
  n,
  e
) {
  ...
  var o = t("translation:widget/common/third_party/template"),
    a = t("translation:widget/translate/details/dictionary/simplemeans"),
    i = t("translation:widget/common/soundURIGenerator"),
    r = $("#left-result-container");
    ...
    buildSynonym: function(t) {
      ...
      r.append(e),
        _hmt.push([
          "_trackEvent",
          "首页",
          "66_首页页面_Web同义词辨析Tab展现量"
        ]);
    },
    bindEvents: function() {
      var t = this;
      $(".translate-wrap")
        .on("click", ".synonym-item .op-sound", function() {
          t.clickSound({ target: this });
        })
...
define("translation:widget/translate/details/rootsaffixes/rootsaffixes", function(
  t,
  a,
  s
) {
  "use strict";
  var e = t("translation:widget/common/third_party/template"),
    n = t("translation:widget/translate/sideNav/sideNav"),
    o = $("#left-result-container"),
    i = {
      ...
      bindEvents: function() {
        o.on("click", ".ras-collapse-expand-btn", function() {
          var t = $(this)
            .parent()
            .find(".ras-mean");
          t.hasClass("to-expand")
            ? (t.removeClass("to-expand").addClass("to-collapse"),
              n.setupPos(),
              _hmt.push([
                "_trackEvent",
                "首页",
            ...
            : (t.removeClass("to-collapse").addClass("to-expand"),
              n.setupPos(),
              n.mockScrollingClickFlag(!1),
              n.checkPos(),
              _hmt.push([
                "_trackEvent",
                "首页",
...
define("translation:widget/translate/details/usecase/usecaseTemplateHelper", function(
  e
) {
  "use strict";
...
define("translation:widget/translate/details/usecase/usecase", function(
  e,
  t,
  a
) {
    ...
    l = {
      ...
      buildUsecase: function(e) {
        ...
        r.append(a),
          ...
          $(".usecase-cont")
            ...
            .eq(0)
            .removeClass("hide"),
          d.indexOf("Firefox") < 0 && $(".ex-zh").addClass("ex-zh-clamp"),
          _hmt.push(["_trackEvent", "首页", "Web词语用例Tab展现量"]);
      },
      bindEvents: function() {
        var e = this;
        ...
        t.find(".usecase-sound").addClass("usecase-sound-active"),
          ...
          "phrase" === t.data("type")
            ? _hmt.push([
                "_trackEvent",
                "首页",
                "首页页面_词语用例_词组发音按钮的点击量"
              ])
            : "sentence" === t.data("type") &&
              _hmt.push([
                "_trackEvent",
                "首页",
                "首页页面_词语用例_例句发音按钮的点击量"
              ]);
      },
        ...
        if (!t.hasClass("cur")) {
          ...
          t
            ...
            n
              ...
              .siblings()
              .addClass("hide"),
            this.genCollapse({ target: s }),
            i.setupPos(),
            r &&
              (r.hasClass("oxford-phrasalverb-only")
                ? this.hideOxford(!1)
                : (this.hideOxford(!0),
      ...
      genCollapse: function(e) {
        ...
        if (t[0].hasAttribute("data-collapse-height")) {
          ...
          s.css("max-height", "none"),
            s.height() > a
              ? (t.removeClass("to-collapse").addClass("to-expand"),
                s.css("max-height", a + "px"))
              : t.removeClass("to-expand").removeClass("to-collapse");
        }
      },
      showOxford: function(e) {
        ...
        t.attr("data-expand-top", s).addClass("hide"),
          ...
          a.hasClass("to-expand") ||
            a.hasClass("to-collapse") ||
            $(".oxford-to-collapse").removeClass("hide"),
          i.setupPos(),
          _hmt.push([
            "_trackEvent",
            "首页",
            "首页页面_词语用例_短语动词牛津查看更多的点击量"
          ]);
      },
  ...
  function s(a, t, s, j, N) {
    ...
    !(function() {
      if (
        ...
        (a.dict_result.simple_means &&
          !N &&
          ((O = a.dict_result.simple_means),
          (C = a.dict_result.baike_img_url),
          a.dict_result.simple_means.symbols &&
            a.dict_result.simple_means.symbols.length > 0 &&
            (I = JSON.stringify({
              simple_means: { symbols: a.dict_result.simple_means.symbols }
            })),
        ...
        for (var e in a.dict_result)
          if (
            a.dict_result[e] instanceof Object &&
            !$.isEmptyObject(a.dict_result[e]) &&
            0 !== a.dict_result[e].length
          )
            switch (e) {
              case "collins":
                W.collins = !0;
              ...
              case "general_knowledge":
                a.dict_result.general_knowledge.similar_words &&
                  (W.wordColl = !0);
                break;
              case "netdata":
                W.webMeaning = !0;
      ...
      (W.simpleMeaning = Boolean(O)),
        !a.liju_result ||
          ("en" !== s && "zh" !== s) ||
          (!a.liju_result["double"] && !a.liju_result.single) ||
          (W.illSen = !0),
        a.trans_result &&
          a.trans_result.keywords &&
          a.trans_result.keywords.length > 0 &&
          (("zh" === t && "en" === s) || ("en" === t && "zh" === s)) &&
          !W.simpleMeaning &&
          (W.keyWord = !0),
        a.simworks &&
          "[object Object]" === Object.prototype.toString.call(a.simworks) &&
          (W.translator = !0);
    })();
    var B = [],
      F = !1;
    !(function() {
      if (
        (e("translation:widget/translate/sideNav/navSorter/listOperator")
          .getNavList()
          .forEach(function(e) {
            var a = E[e];
            W[a] && B.push(a);
        ...
        W.festivalLink && a.push("festivalLink"),
          ...
          "simpleMeaning" !== B[0]
            ? (B.unshift.apply(B, a), W.adLink && W.festivalLink && (F = !0))
            : B.splice.apply(B, [1, 0].concat(a));
      }
    ...
    J && i.showAppQr(F),
      b.init({ from: t, to: s, query: j, dictJSON: I }),
      ("en" === t && "zh" === s) || ("zh" === t && "en" === s)
        ? (y.genCollapse(), f.genNav())
        : f.destroyNav();
  }
  {
...
define("translation:widget/translate/input/uploader", function(t, e, i) {
  "use strict";
  var o = t(
      "translation:widget/common/third_party/webuploader/webuploader.fis"
    ),
    n = (t("translation:widget/common/environment"),
    o.create({
      swf:
        "//fanyi.bdstatic.com/static/translation/widget/common/third_party/webuploader/Uploader_10d5704.swf",
      ...
      accept: [
        ...
        },
        {
          ...
          mimeTypes:
            ...
            (window.common.pdfHit ? ",application/pdf" : "")
        }
      ]
    }));
  i.exports = n;
});
define("translation:widget/translate/docTranslate/docTransUtil", function(
  e,
  n
) {
  "use strict";
  var t = e("translation:widget/translate/input/uploader"),
    o = e("translation:widget/common/environment"),
    r = $(".doc-trans-view-wrap .progress-bar"),
    a = $(".doc-trans-view-wrap"),
  ...
  (n.isSupportByDocTrans = function(e) {
    return (
      "application/msword" === e ||
      "application/vnd.openxmlformats-officedocument.wordprocessingml.document" ===
        e ||
      (window.common.pdfHit && "application/pdf" === e)
    );
  }),
    (n.currTask = c);
  var d = {
    ...
    uploadSuccess: function() {
      (this.percentage = 30),
        r.css("transform", "scaleX(" + this.percentage / 100 + ")");
    },
    reset: function() {
      (this.percentage = 0), r.removeAttr("style");
    },
    add: function() {
      this.percentage + 30 < 95 &&
  ...
  (n.progress = d),
    (n.clearDocTrans = function(e) {
      $("#main-outer")
        .removeClass("doc-trans-mode")
        .removeClass("doc-trans-view-mode"),
        $(".doc-trans-file").text(""),
        window.common.docHit &&
          !o.get("isInRtTransState") &&
          $("#upload-btn").show(),
        c.file && t.cancelFile(c.file),
        (c.fileName = ""),
        (c.from = ""),
        (c.to = ""),
        (c.token = "");
      ...
      n
        .find(".loading-container, .loading-err-container, .loading-exit-btn")
        .removeAttr("style"),
        n
          .find(".export-doc-btn")
          .removeClass("generating")
          .prop("data-has-gen-link", !1),
        n.removeClass("loading viewing"),
    ...
    (n.clearDocTransViewMode = function() {
      a.find(".file-name").text(""),
        a.find(".doc-view-from-lang").text(""),
        a.find(".doc-view-to-lang").text(""),
        a.find(".loading-container").removeAttr("style"),
        a.find(".loading-err-container").removeAttr("style"),
        a.removeClass("loading viewing"),
        d.reset(),
        $("#main-outer").removeClass("doc-trans-view-mode"),
        $(".footer").show();
    }),
    (n.viewModeRegExp = s),
    (n.logWrongFileFormat = function(e) {
      var n = "未知格式";
      if (e && e.name) {
        var t = e.name.split(".");
...
define("translation:widget/translate/docTranslate/docTranslate", function(
  e,
  n,
  t
) {
  ...
  function o() {
    var e = w.currTask;
    g.find(".file-name").text(e.fileName),
      g.find(".doc-view-from-lang").text(window.common.langList[e.from]),
      g.find(".doc-view-to-lang").text(window.common.langList[e.to]),
      k.show(),
      x.hide(),
      g.addClass("loading"),
      (y = null);
  ...
  function s() {
    return new Promise(function(e, n) {
      $.ajax({
        url:
          "https://fanyi-doc.baidu.com/doctrans/api/querytransresult?fileToken=" +
          w.currTask.token,
        type: "GET",
        dataType: "json",
        cache: !1,
  ...
  function d(e) {
    ...
    (r.type = "text/css"),
      (r.innerHTML = n),
      (r.id = "doc-specified-style"),
      document.head.appendChild(r),
      R.html(t),
      A.html(t),
      R.find(".translated-span").each(function(e, n) {
        var t = $(n);
        t.text(t.attr("data-src-str"));
      }),
      (y = $(".doc-whole-container .translated-span")),
      l(),
      window._hmt.push([
        "_trackEvent",
        "首页",
        "文档翻译_结果页展现，成功展示原文译文对照"
      ]);
  }
  function l() {
    $("#doc-fill-div").remove();
  ...
  function u() {
    return new Promise(function(e, n) {
      $.ajax({
        url:
          "https://fanyi-doc.baidu.com/doctrans/api/querydownload?fileToken=" +
          w.currTask.token,
        type: "GET",
        dataType: "json",
        cache: !1,
  ...
  function f() {
    ...
    if (Array.isArray(t)) {
      var r = p(t, 5),
        ...
        s = r[3],
        l = r[4];
      Object.assign(w.currTask, { fileName: a, from: i, to: s, token: l }),
        o(),
        w.clearDocTransMode(),
        ...
        U.uploadSuccess(),
        h().then(function(e) {
          $("#main-outer").hasClass("doc-trans-view-mode") &&
            (k.removeAttr("style"),
            x.removeAttr("style"),
            g.removeClass("loading").addClass("viewing"),
            d(e),
            _.scrollTop(0));
        }, c);
    }
                ...
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    (window.location.href =
                      "https://fanyi-doc.baidu.com/doctrans/download?fileToken=" +
                      w.currTask.token),
                      (n.next = 21);
                    break;
                  case 6:
                  ...
                  case 10:
                    ...
                    return (
                      D.removeClass("generating").prop("data-has-gen-link", !0),
                      (window.location.href =
                        "https://fanyi-doc.baidu.com/doctrans/download?fileToken=" +
                        w.currTask.token),
                      n.abrupt("return")
  ...
  var w = e("translation:widget/translate/docTranslate/docTransUtil"),
    v = e("translation:widget/translate/input/uploader"),
    g = $(".doc-trans-view-wrap"),
    k = g.find(".loading-container"),
    x = g.find(".loading-err-container"),
    T = g.find(".err-title"),
    b = g.find(".err-content"),
    y = null,
    C = g.find(".doc-whole-container"),
    _ = g.find(".src-doc-scroll-wrapper,.dst-doc-scroll-wrapper"),
    E = g.find(".src-doc-scroll-wrapper"),
    j = g.find(".dst-doc-scroll-wrapper"),
    R = g.find(".src-doc-padding-wrapper"),
    A = g.find(".dst-doc-padding-wrapper"),
    q = g.find(".loading-exit-btn"),
    M = g.find(".err-exit-btn"),
    P = g.find(".err-re-upload-btn"),
    S = g.find(".view-re-upload-btn"),
    D = g.find(".export-doc-btn"),
    I = g.find(".view-file-name"),
    N = 120,
    O = 5e3,
    U = w.progress;
  !(function() {
    v.on("uploadSuccess", function(e, n) {
      ...
      q.add(M).on("click", function(e) {
        $(e.currentTarget).is(q)
          ? window._hmt.push([
              "_trackEvent",
              "首页",
              "文档翻译_loading点击退出按钮"
            ])
          : $(e.currentTarget).is(M) &&
            window._hmt.push([
              "_trackEvent",
              "首页",
              "文档翻译_文档解析失败点击退出按钮"
      ...
      P.add(S).on("click", function(e) {
        $(e.currentTarget).is(S)
          ? window._hmt.push(["_trackEvent", "首页", "文档翻译_点击翻译下一篇"])
          : $(e.currentTarget).is(P) &&
            window._hmt.push([
              "_trackEvent",
              "首页",
              "文档翻译_文档解析失败点击重新上传"
      ...
      D.on("click", m),
      C.on("mouseenter", "span.translated-span", function(e) {
        var n = $(e.currentTarget),
          t = n.attr("data-span-idx"),
          r = null,
          a = null,
          o = null;
        E.find(n).length > 0 ? ((r = E), (a = j)) : ((r = j), (a = E)),
          (o = a.find(".translated-span[data-span-idx='" + t + "']")),
        ...
        var i = a.offset().top,
          ...
          d = c + o.height(),
          l = d - s;
        if (l > 0) a.scrollTop(a.scrollTop() + l);
        else {
          var u = i - c;
      ...
      E.scrollbar(),
      j.scrollbar(),
      _.on("scroll", function(e) {
        if (0 !== y.length) {
          var n = $(e.currentTarget);
          if (n.is(":hover")) {
            var t = n.hasClass("src-doc-scroll-wrapper") ? j : E,
              r = 0,
              a = -1,
              o = n.find(".translated-span"),
              i = n.offset().top,
              s = null,
              c = 0;
            do {
            ...
            if (-1 !== a) {
              var u = t.find("[data-span-idx='" + a + "']"),
                f = t.offset().top + r - u.offset().top;
...
define("translation:widget/translate/docTransLang/docTransLang", function(n) {
  ...
  function t(n) {
    ...
    l.removeClass("selected"),
      l.filter('[data-dir="' + n + '"]').addClass("selected"),
      d.find(".from-doc-lang").text(window.common.langList[a]),
      d.find(".to-doc-lang").text(window.common.langList[e]),
      s.removeClass("open"),
      (u.from = a),
      (u.to = e);
  }
  ...
  var e = n("translation:widget/translate/input/uploader"),
    r = n("translation:widget/translate/docTranslate/docTransUtil"),
  ...
  !(function() {
    $(".doc-trans-btn").on("click", function() {
      e.option("formData", u),
        e.upload(r.currTask.file),
        Object.assign(r.currTask, u);
      var t = n("translation:widget/translate/docTranslate/docTranslate");
      t.loading(),
        $("#main-outer")
          .removeClass("doc-trans-mode")
          .addClass("doc-trans-view-mode"),
        $(".footer").hide(),
        window._hmt.push(["_trackEvent", "首页", "文档翻译_点击翻译按钮"]);
    }),
      d.on("click", function() {
      ...
      $("body").on("click", function(n) {
        var t = $(n.target);
        0 !== s.find(t).length || t.is(s)
          ? window._hmt.push(["_trackEvent", "首页", "文档翻译_点击语言设置框"])
          : s.removeClass("open");
      });
  })();
});
    ...
    o = {
      ...
      getCopyedText: function() {
        var t = !!$(".op-double-lang span").hasClass("op-checked"),
          n = void 0;
        n = $(".output-wrap .output-bd").find(
          t ? ".ordinary-output" : ".target-output"
        );
        var e = "";
        return (
          n.each(function() {
        ...
        for (var e = [], r = t.length, a = 0; r > a; ++a) {
          ...
          for (var c = 0, o = t[a].result.length; o >= c; c++) {
            ...
            if (c === o) {
              ...
              if (
                ((s = 0 === a ? t[a].result[c][2][0] : t[a].result[c][4][0]),
...
define("translation:widget/translate/output/lmHandler", function(t, a) {
  ...
  var r = (t("translation:widget/common/environment"),
  {
    execData: function(t) {
      ...
      for (var e = 0; n > e; e++)
        " " !== t[e].src_str &&
          (" " !== t[e].trg_str && (this.hasLmData = !0),
          "\n" === t[e].src_str
            ? (a[++r] = [])
            : a[r].push({ src: t[e].src_str, trg: t[e].trg_str }));
      this.lmDataNew = a;
    }
  });
...
define("translation:widget/translate/output/correctResult/correctResult", function(
  t,
  e,
  o
) {
    ...
    d = {
      ...
      bindEvents: function() {
        ...
        $(".output-wrap").on("click", ".op-correct", function() {
          ...
          u
            .on("click", ".output-correct-btn-close", function(e) {
          ...
          i
            ...
            .on("input keyup paste", function(e) {
              ...
              ("input" !== e.type &&
                ...
                (t.verifyInput(), $.trim(o.val()) && c.hide());
            });
      },
      ...
      verifyInput: function() {
        ...
        return (
          ...
          t
            ? a.removeClass("output-correct-btn-submit-disable")
            : a.addClass("output-correct-btn-submit-disable"),
          t
        );
      },
                ...
                return e
                  ? e && 0 === e.errno
                    ? (n.show("感谢反馈，您的反馈将用于提高翻译质量。"),
                      void t.hideCorrectModel())
                    : e && 0 !== e.errno
                    ? void n.show(e.errmsg)
                    : void n.show("网络不可用，提交失败。")
                  : void n.show("网络不可用，提交失败。");
              },
              error: function() {
                n.show("网络不可用，提交失败。");
      ...
      getSendData: function() {
        var t = this.getOriResult(),
          e = void 0,
          o = {
            from: $(".select-from-language .language-selected").attr(
              "data-lang"
            ),
        ...
        return (
          $(".output-correct-type-box input").each(function(t, e) {
            var r = $(e);
      ...
      resetModel: function() {
        ...
        t.length > 0 &&
          ...
          a.hasClass("output-correct-btn-submit-disable") &&
            a.removeClass("output-correct-btn-submit-disable"),
          i.val("").blur(),
          (s = ""),
          (l = !0);
    ...
    n = {
      bindEvents: function() {
        $(document).on("click", $.proxy(this.clickDocument, this)),
          $(".output-wrap")
            .on("click", ".edit-tip a", $.proxy(this.listItemClicked, this))
            .on(
              "click",
              ".target-output > span[space]",
              $.proxy(this.editSpanClicked, this)
            );
      },
      clickDocument: function(t) {
        var a = t.target;
        $(a).hasClass("ordinary-span-edit") ||
          "block" ===
            $(a)
              .parents(".edit-tip")
              .css("display") ||
          ($(".output-wrap .target-output span").removeClass(
            "ordinary-span-edit"
          ),
          "block" === $(".edit-tip").css("display") && $(".edit-tip").hide());
      },
      listItemClicked: function(t) {
        this.listItemSelected({ target: t.target }),
      ...
      listItemSelected: function(t) {
        ...
        return $(e).hasClass("edit-input")
          ? void $(".edit-input").focus()
          : ((a = $.trim(
              $(e).hasClass("edit-submit")
                ? $(".edit-input").val()
                : $(e).text()
            )),
            this.checkSpanChange({ target: $(i), newText: a }),
      ...
      checkSpanChange: function(t) {
        ...
        0 !== s.length &&
          ...
          (o = $.trim(o)),
          $(".ordinary-wrap .op-sound").length > 0 &&
            o &&
            $(".ordinary-wrap .op-sound").attr(
              "data-sound-text",
      ...
      execSpanClicked: function(t) {
        ...
        e.hasClass("ordinary-span-edit") ||
          ("-1" !== s && (i[n] = { oritext: r }),
          $(a)
            .attr("tabcount", -1)
            .addClass("ordinary-span-edit")
            .focus()
            .siblings("span")
            .removeClass("ordinary-span-edit"),
          $(a)
            .parents("p")
            .siblings()
            .find("span")
            .removeClass("ordinary-span-edit"),
          i[n] && i[n].data
            ? this.showEditTipBox({ target: a, data: i[n].data })
            : ("zh" == o && "yue" == d) ||
              ("en" == o && "ara" == d) ||
              ("yue" == o && "zh" == d) ||
              ("ara" == o && "en" == d) ||
              ("zh" == o && "wyw" == d) ||
              ("wyx" == o && "zh" == d)
            ? this.showEditTipBox({ target: a, data: [] })
  ...
  var o = e("translation:widget/common/environment"),
    ...
    n = {
      ...
      bindEvents: function() {
        var e = this;
        $(".output-wrap")
          .on("click", ".op-double-lang", function() {
      ...
      doubleLangClicked: function(e) {
        var t = e.target,
          ...
          n = !1;
        a.hasClass("op-check")
          ? (this.doubleLangNeedChecked(),
            a.removeClass("op-check").addClass("op-checked"),
            (n = !0),
            o.set("doubleLangChecked", !0))
          : a.hasClass("op-checked") &&
            (this.doubleLangNeedShutdown(),
            a.removeClass("op-checked").addClass("op-check"),
            o.set("doubleLangChecked", !1)),
          s.sameHeight();
      },
      doubleLangNeedChecked: function() {
        a.setCookie("DOUBLE_LANG_SWITCH", 1, { expires: 2592e6 }),
          $(".source-output").show(),
          $(".output-wrap .op-copy").attr(
            "data-hover-tip-text",
            "复制双语结果"
          ),
      ...
      doubleLangNeedShutdown: function() {
        a.setCookie("DOUBLE_LANG_SWITCH", 0, { expires: 2592e6 }),
          $(".source-output").hide(),
      ...
      switchJapan: function(e) {
        ...
        n.hasClass("op-checked")
          ? (t.hide(),
            o.show(),
            a.setCookie("JAPAN_PINYIN_SWITCH", 0, { expires: 2592e6 }),
            n.removeClass("op-checked").addClass("op-check"),
            _hmt.push(["_trackEvent", "首页", "web端关闭日语假名对照"]))
          : (t.show(),
            o.hide(),
            a.setCookie("JAPAN_PINYIN_SWITCH", 1, { expires: 2592e6 }),
      ...
      switchLuoma: function(e) {
        ...
        n.hasClass("op-checked")
          ? (t.hide(),
            o.show(),
            a.setCookie("LUOMA_PINYIN_SWITCH", 0, { expires: 2592e6 }),
            n.removeClass("op-checked").addClass("op-check"),
            _hmt.push(["_trackEvent", "首页", "web端关闭韩语罗马音对照"]))
          : (t.show(),
            o.hide(),
            a.setCookie("LUOMA_PINYIN_SWITCH", 1, { expires: 2592e6 }),
            n.removeClass("op-check").addClass("op-checked"),
      ...
      switchZhong: function(e) {
        ...
        n.hasClass("op-checked")
          ? (t.hide(),
            o.show(),
            a.setCookie("CHINA_PINYIN_SWITCH", 0, { expires: 2592e6 }),
            n.removeClass("op-checked").addClass("op-check"),
            _hmt.push(["_trackEvent", "首页", "web端关闭中文拼音对照"]))
          : (t.show(),
            o.hide(),
            a.setCookie("CHINA_PINYIN_SWITCH", 1, { expires: 2592e6 }),
            n.removeClass("op-check").addClass("op-checked"),
  ...
  var e = t("translation:widget/common/environment"),
    ...
    i = {
      bindEvents: function() {
        var t = this;
        $(".output-wrap")
          .on("mouseover", ".target-output > span[space]", function() {
      ...
      onFloatingYellow: function(t) {
        ...
        var p = ($(".select-from-language .language-selected").attr(
          "data-lang"
        ),
        $(".select-to-language .language-selected").attr("data-lang"),
        l.length);
...
define("translation:widget/translate/output/fanyiClickBtn", function(t, n) {
  "use strict";
  var e = (t("translation:widget/common/environment"),
    t("translation:widget/common/soundURIGenerator")),
    i = t("translation:widget/translate/details/dictionary/simplemeans"),
    a = {
      bindEvents: function() {
        var t = this;
    ...
    normaltrans: function(t) {
      for (
        var a = t.data.data,
          ...
          u = t.data.phonetic,
          d = {},
          g = $(".select-to-language .language-selected").attr("data-lang"),
          c = $(".select-from-language .language-selected").attr("data-lang"),
          D = e.get("rtl"),
          h = $.inArray(g, D) >= 0,
          w = $.inArray(c, D) >= 0,
          y = $.inArray(g, ["ara", "ru", "el"]) >= 0,
          C = "",
          I = a.length,
          k = [],
          L = [],
      ...
      if ($("#original-output").length <= 0) {
        var P =
          '<div style="display:none;" id="original-output">' + T + "</div>";
        $("body").append(P);
      } else
      ...
      "1" === q && (F = !0),
        ...
        (d.tplData.spell = ""),
        r.getByte(C) <= i.getMaxSoundLength(g) &&
          (d.tplData.spell = encodeURIComponent(C)),
        (d.tplData.spellLang = ""),
  ...
  var a = t("translation:widget/common/environment"),
    ...
    c = {
      ...
      bindEvents: function() {
        var t = this;
        $(".translate-wrap")
          .on("mouseover", ".data-hover-tip", function() {
      ...
      outputTextIsCopy: function(t) {
        ...
        e &&
          (window.clipboardData
            ...
            ? (t.originalEvent.clipboardData.setData("text/plain", e),
              t.preventDefault())
            : t.clipboardData &&
      ...
      checkResponse: function(t, e) {
        ...
        var a = t.res;
        return a.error
          ? void (999 === parseInt(a.error, 10)
              ? (this.clearOutputWrap(),
                o.normaltrans(
                  {
                    data: { data: [{ dst: a.query, src: a.query, result: [] }] }
                  },
                  t.query
                ))
              : 998 === parseInt(a.error, 10)
              ? window.location.reload()
              : 997 === parseInt(a.error, 10)
              ? alert("浏览器cookie功能被禁，请开启此功能")
              : this.showTimeout())
          : void this.execResponse(t, e);
      },
      showTimeout: function() {
        var t = { message: "非常抱歉，翻译结果响应超时，请稍后再试!" },
      ...
      execResponse: function(t, e) {
        ...
        !e && _hmt.push(["_trackEvent", "首页", "web端总共query数"]),
          a &&
            (this.clearOutputWrap(),
            a.trans_result && o.normaltrans({ data: a.trans_result }),
            s.init(a, n, r, i, u));
      },
      clearOutputWrap: function() {
        r.hideAppQr(),
          ...
          i.isout(),
          a.get("needLongtextTip") === !0
            ? ($(".output-wrap .output-mod").remove(),
              a.set("needLongtextTip", !1))
            : $(".output-wrap")
                .empty()
                .addClass("output-blank"),
          l.empty();
      }
    };
  $(function() {
...
define("translation:widget/translate/translang/langoften", function(e, t) {
  ...
  var l = {
    ...
    setLangOften: function(e) {
      ...
      for (
        ...
        t.shift();
      t.length > 0 &&
        (a.setCookie(l, escape(JSON.stringify(t)), { expires: 2592e6 }),
        f.call(this));
    },
    ...
    getLangOften: function(e) {
      ...
      if (a.getCookie(g)) {
        ...
        for (var i = "", s = n.get("ocrLangList"), r = 0; r < g.length; r++) {
          ...
          i +=
            t.find(".lang-selected").length <= 0 && u.value === f
              ? '<li><a href="javascript:void(0);" value=' +
                u.value +
                ' class="data-lang lang-selected' +
                (c ? " support-ocr" : "") +
                '">' +
                u.text +
                "</a></li>"
        ...
        l.length <= 0 &&
          (i += '<li class="language-often-text">-常用语种</li>'),
          t.append(i);
      }
    },
    showOftenBubble: function() {
      a.getCookie("HIDEOFTENLANGBUBBLE")
        ? $(".often-lang-bubble").hide()
        : $(".often-lang-bubble").show();
    },
    hideOftenBubble: function() {
      $(".often-lang-bubble").hide(),
        a.setCookie("HIDEOFTENLANGBUBBLE", 1, { expires: 2592e7 });
    },
    bindEvents: function() {
      var e = this;
  ...
  $(function() {
    l.setDefault({ langOften: "from_lang_often" }),
      l.setDefault({ langOften: "to_lang_often" }),
      l.getFromOften(),
      l.getToOften();
  }),
...
define("translation:widget/translate/translang/manualTrans", function(a, t, e) {
  ...
  s.on("click", function() {
    $(this).hasClass("manual-trans-btn-disable") ||
      (_hmt.push(["_trackEvent", "首页", "16_首页页面_点击人工翻译按钮"]),
      l({
        from: $(".select-from-language .language-selected").attr("data-lang"),
        to: $(".select-to-language .language-selected").attr("data-lang"),
        query: r.getVal(),
        middlePageUrl:
          "http://fanyi-pro.baidu.com/middlepage?hmsr=%E7%99%BE%E5%BA%A6%E7%BF%BB%E8%AF%91&hmpl=%E5%9B%BA%E5%AE%9A%E5%85%A5%E5%8F%A3&hmcu=%E9%A6%96%E9%A1%B5%E6%8C%89%E9%92%AE&hmkw=&hmci=",
        $appendToEle: s
      }));
  }),
  ...
  var e = a("translation:widget/common/third_party/template"),
    ...
    o = {
      toBtnClicked: function() {
        "none" === $(".to-language-list").css("display") &&
          this.reRenderToList(),
          $(".to-language-list").toggle(0, function() {
            "block" === $(".to-language-list").css("display")
              ? $(".select-to-language .arrow-down").addClass("lang-arrow-up")
              : "none" === $(".to-language-list").css("display") &&
                $(".select-to-language .arrow-down").removeClass(
                  "lang-arrow-up"
                );
          });
      },
      ...
      tolangChange: function(a) {
        ...
        $(".to-language-list .data-lang").each(function() {
          var n = $(this);
          return n.attr("value") === t
            ? (e.tolangItemSelect({ target: n, trans: a.trans }), !1)
            : void 0;
        });
      },
      tolangItemSelect: function(a) {
        var t = a.target,
          e = t.attr("value"),
          n = t.text();
        $(".select-to-language .language-selected")
          .attr("data-lang", e)
          .text(n),
...
define("translation:widget/translate/translang/exchange", function(a, n) {
  "use strict";
  var t,
    e = a("translation:widget/common/environment"),
    ...
    s = {
      clickExchangeBtn: function() {
        ...
        if (!a.hasClass("language-btn-disable")) {
          var n = $.trim($("#baidu_translate_input").val()).replace(
            /<br( \/)?>/gi,
            "&lt;br$1&gt;"
          );
      ...
      animateExchange: function() {
        ...
        1 === parseInt(e.attr("aflag"), 10)
          ? (a(-2, -202, 8, 200), e.attr("aflag", 0))
          : (a(-202, -2, 8, 200), e.attr("aflag", 1));
      },
      ...
      execExchange: function(a) {
        ...
        $(".select-inner").stop(!0, !0),
          ...
          $(".select-inner").css({ left: 0 }),
          g.fromlangChange({ lang: i }),
          l.tolangChange({ lang: e, trans: !a });
      },
      judgeExchangeShow: function() {
        "auto" ===
        $(".select-from-language .language-selected").attr("data-lang")
          ? this.disableExchangeBtn()
          : this.enableExchangeBtn();
      },
      enableExchangeBtn: function() {
        var a = $(".from-to-exchange");
        a.hasClass("language-btn-disable") &&
          a.removeClass("language-btn-disable").addClass("language-btn");
      },
      disableExchangeBtn: function() {
        var a = $(".from-to-exchange");
        a.hasClass("language-btn") &&
          a.removeClass("language-btn").addClass("language-btn-disable");
      }
    };
...
define("translation:widget/translate/input/processlang", function(t, n, e) {
  ...
  function a(t, n, e) {
    return (
      g.set("detectLang", t),
      g.get("fromLangIsAuto")
        ? ((n = t),
          (e = $(".select-to-language .language-selected").attr("data-lang")))
        : t !== e ||
          g.get("langChangedByUser") ||
          ("zh" === e && $.inArray(n, o) >= 0
            ? (s.execExchange(!0), (e = n), (n = t), $(".trans-prompt").hide())
            : "zh" === n &&
              $.inArray(e, o) >= 0 &&
              (s.execExchange(!0),
              (e = n),
  ...
  function r(t, n, e) {
    return (
      l.includes(n) && l.includes(e) && t === e
        ? (s.execExchange(!0), (e = n), (n = t), $(".trans-prompt").hide())
        : (c.includes(n) && "en" === e) ||
          !g.get("langList").hasOwnProperty(t) ||
          i.renderPrompt(t, !0),
      { fromLang: n, toLang: e }
    );
  }
  ...
  var o = n("translation:widget/common/config/sound"),
    ...
    s = {
      ...
      show: function() {
        ...
        return !o.isLangSound(n) || s > t
          ? (this.showDisableSoundIcon(), void this.hideSoundBtn())
          : void this.showSoundBtn();
      },
  ...
  var i = t("translation:widget/common/config/trans"),
    p = {
      showTip: function(t) {
        ...
        $(".long-text-prompt-wrap").length <= 0 &&
          $(".output-wrap").prepend($(r));
      },
      hideTip: function() {
  ...
  var e = t("translation:widget/translate/input/prompt"),
    ...
    w = {
      onTrans: function(t) {
        ...
        if (
          (a.length > 0 && p.sendIndexDisplayLog({ action: "query" }),
          this.isQueryValid(a))
        ) {
          var o = a;
          o.length > 50 &&
            (o = l.cutByByte(o, 0, 50).replace(/[\uD800-\uDBFF]$/, ""));
          var i = { query: o };
          $.ajax({
            url: "/langdetect",
            type: "POST",
      ...
      processQuery: function(t) {
        ...
        if (l.getByte(t) > o.MAX_QUERY_COUNT) {
          ...
          var e = t;
          (a = l
            .cutByByte(t, 0, o.MAX_QUERY_COUNT)
            .replace(/[\uD800-\uDBFF]$/, "")),
      ...
      langIsDeteced: function(t, a, n, r) {
        if (null !== t) {
          var s = $(".select-from-language .language-selected").attr(
              "data-lang"
            ),
          ...
          var g = null;
          r && !c.get("fromLangIsAuto") && s !== t
            ? (g = i.processOcrLang(t, s, o))
            : (e.show(t, s), (g = i.getLang(t, s, o))),
            u.show();
          var d = this,
          ...
          this.translateXHR &&
            4 !== this.translateXHR.readyState &&
      ...
      translateSuccess: function(t, a, e, r, i) {
        return n.getVal()
          ? (r &&
              encodeURIComponent(r).length < o.MAX_URL_COUNT &&
              f.add(a, e, $.trim(r)),
            f.hideHistory(),
            h.hide(),
            s.checkResponse({
...
define("translation:widget/translate/input/urlQueryHandler", function(t, r) {
  ...
  (l.tpl = [
    '<div class="url-tip">',
    "点击翻译按钮，可以对您输入的网站进行全文翻译。",
    "</div>"
  ].join("")),
    (l.dealUrlQuery = function() {
      $(".operate-btn").css("display", "none"),
        $(".ordinary-wrap").length > 0
          ? $(".ordinary-wrap").html(this.tpl)
          : ($(".output-wrap").html(this.tpl),
            $(".url-tip").css({ margin: "10px" }));
    }),
...
define("translation:widget/translate/input/inputSoungUrlHandler", function(
  t,
  n
) {
  "use strict";
  var e = t("translation:widget/translate/input/textarea"),
    ...
    r = {
      getInputSoundUrl: function() {
        ...
        return (
          "yue" === t && (t = "cte"),
          (r = a.generateURI({ lan: t, text: encodeURIComponent(n) }))
        );
      }
    };
...
define("translation:widget/translate/input/inputSug", function(t, e) {
  ...
  function u(t) {
    ...
    if (13 === t.which) {
      ...
      if ("none" !== m.css("display"))
        return (y = !0), t.preventDefault(), t.stopPropagation(), void n();
    }
  }
  function r() {
    return v;
  ...
  var d,
    f = t("translation:widget/common/third_party/template"),
    ...
    w = {
      init: function() {
        (this.sugIdx = 0),
          ...
          m
            .on("mouseenter", ".sug-item", function() {
              var t = $(".sug-item");
          ...
          $(document).on("click", function(t) {
            var e = $(t.target);
            "none" === m.css("display") ||
              e.hasClass("trans-input-wrap") ||
              e.parents(".trans-input-wrap").length > 0 ||
              n();
          });
      },
      loadSug: function() {
    ...
    h = {
      ...
      clearInput: function(n) {
        r.hide(),
          ...
          p.clearDocTrans(),
          t(
            "translation:widget/translate/input/dataTransfer"
          ).clearInputImage();
        var s = $(".translateio");
      ...
      clearAll: function(t) {
        s.clearOutputWrap(),
          ...
          d.destroyNav(),
          this.setEmptyHash(),
          l.sendIndexBannerLog({ source: "clear" });
      },
      showIcon: function() {
        this.clearBtn.show();
      },
...
define("translation:widget/translate/input/fontSize", function(t, e) {
  ...
  function n() {
    ...
    var t = i.val();
    c && "10.0" === c[1]
      ? i.removeClass("small-font").val(t)
      : i.removeClass("small-font"),
  ...
  function l() {
    ...
    var t = i.val();
    c && "10.0" === c[1]
      ? i.addClass("small-font").val(t)
      : i.addClass("small-font"),
      ...
      renderWrap: function(t, e) {
        if (0 === t.error && t.lan) {
          var o = this.dom.from.attr("data-lang"),
            ...
            a = t.lan ? t.lan : o,
            i = a === n ? o : n;
          $(".zonedword-search-input")
            .val(e)
            .attr("data-dir", a + "2" + i),
            this.setDetailLink(a, i, e),
            r.show(),
            $(".zonedword-result").empty(),
            this.ajaxGetTrans({ fromLang: a, toLang: i, query: e });
        }
      },
      ajaxGetTrans: function(t) {
        var e = this,
          o = { from: t.fromLang, to: t.toLang, query: t.query, source: "txt" };
        $.ajax("/transapi", {
          type: "POST",
          data: o,
          success: function(o) {
      ...
      transResultIsReturn: function(t, e, o, n) {
        if (!t || !t.error) {
          ...
          t &&
            t.type &&
            (1 === t.type
              ? (a.render({ data: t.result, top: r, left: l }),
                s.init({ query: n, type: 1, from: e, to: o }))
              : 2 === t.type &&
                (i.render({
                  data: t.data,
                  top: r,
                ...
                s.init({ query: n, type: 2, from: e, to: o })),
            _hmt.push(["_trackEvent", "首页", "划词翻译结果框出现次数"]),
            "keywords" === d.get("zonewordQueryFrom") &&
              _hmt.push([
                "_trackEvent",
                "首页",
                "Web重点词汇卡片highlight出划词翻译框次数"
              ]));
        }
      },
      rightClickHideWrap: function(t) {
        ...
        e || $("#zonedword-wrap").hide(),
          t &&
            2 !== t.button &&
            3 !== t.button &&
            ((this.mouseClickFlag = !0), n.clearSelectionZone(t));
      },
...
define("translation:widget/translate/input/drag", function(t, n, o) {
  ...
  function a(t) {
    "drag" === t
      ? i.removeClass("with-drop-tip").addClass("with-drag-tip")
      : "drop" === t
      ? i.removeClass("with-drag-tip").addClass("with-drop-tip")
      : i.removeClass("with-drag-tip with-drop-tip");
  }
...
define("translation:widget/translate/input/autoRequest", function(t, a, n) {
  "use strict";
  function e() {
    if (d.get("isInRtTransState") === !0)
      return void d.set("isInRtTransState", !1);
    var t = i.get(),
  ...
  function r(a) {
    ...
    (d = a ? l.val() : n.query),
      d.length > 0
        ? ((d = d.replace(/\\r\\n/gi, "\n")),
          (d = o.decodeHTML(d)),
          /firefox/i.test(navigator.userAgent) === !0 &&
            ((d = d.replace(/%0A/gi, "\r\n")), (d = unescape(d))),
          a || l.val(d),
          p.switchFontSize(),
          s.hasQuery(d),
        ...
        : h.clearInputAndOutput(),
      s.focus();
    var m = !1;
    e && g.fromlangChange({ lang: e, trans: m }),
      r && u.tolangChange({ lang: r, trans: m }),
      c.onTranslate();
  }
  function l() {
    var t = d.get("remote"),
      ...
      c = l
        ? "auto" !== n.match(e)[2]
          ? n.match(e)[2]
          : window.common.locale
        : !1;
    if (i && c) {
      u.tolangChange({ lang: c, trans: !1 }),
        g.fromlangChange({ lang: i, trans: !1 }),
        (a = o.decodeHTML(a)),
        m.setHash({ from: i, to: c, query: a });
      {
        o.getIEVersion();
      }
      encodeURIComponent(a).length > f.MAX_URL_COUNT &&
        ((a = a.replace(/\\r\\n/gi, "\r\n")), s.getElem().val(a), r(!0));
    } else r();
  }
  {
    var i = t("translation:widget/translate/common/hash"),
      o = t("translation:widget/common/util"),
      ...
      c = t("translation:widget/translate/input/translate"),
      d = t("translation:widget/common/environment"),
      m = t("translation:widget/translate/input/hash"),
      f = t("translation:widget/common/config/trans"),
      h = t("translation:widget/translate/input/clear"),
      p = t("translation:widget/translate/input/fontSize");
...
define("translation:widget/translate/input/events", function(t, n) {
  ...
  function r(t) {
    t.stopPropagation(),
      (!b.pasteCompatibility || b.handle(t)) &&
        (d.onRtTrans(t, "paste"), y.switchFontSize());
  }
  function i(t) {
  ...
  function o(t) {
    ...
    if (
      !(
        "input" !== t.type &&
        (("oninput" in e &&
          (!z || "keyup" !== t.type || (8 !== t.which && 46 !== t.which))) ||
          "keyup" !== t.type ||
          38 === t.which ||
          40 === t.which ||
          k.getCloseSugByEnter() ||
          (13 === t.which && k.getTranslatedByKeyDown()))
      )
    ) {
      var a = y.switchFontSize();
      a || t.triggerByOcr
        ? k.clearAndHideSug()
        : T.getByte(n) <= 24 && k.loadSug();
    }
    if ((C.hideWrap(), m.onHistoryInput(), _.onAdLinkInput(), n)) {
      if (13 === t.which)
        return (
          k.getCloseSugByEnter() && k.setCloseSugByEnter(!1),
          void (k.getTranslatedByKeyDown()
            ? k.setTranslatedByKeyDown(!1)
            : g.onTranslate({ transtype: "enter" }))
        );
      s.hasQuery(n),
        x.get("shouldClearPromptOnInput") &&
          (p.hide(), x.set("shouldClearPromptOnInput", !1));
  ...
  var s = t("translation:widget/translate/input/textarea"),
    ...
    b = t("translation:widget/translate/input/dataTransfer"),
    S = t("translation:widget/translate/input/drag"),
  ...
  (n.onClearBtnClick = function() {
    return $("#main-outer").hasClass("doc-trans-mode")
      ? (window._hmt.push([
          "_trackEvent",
          "首页",
          "文档翻译_上传后点x删除文档"
    ...
    (n.init = function() {
      ...
      f
        ...
        $(".trans-prompt")
          .on("click", ".source-lang", function(t) {
            t.preventDefault();
        ...
        $(".trans-input-wrap").on("click", ".input-wrap", function(t) {
          var n = $(t.target);
          (n.hasClass("input-wrap") || n.hasClass("textarea-wrap")) &&
      ...
      g.on("click", function() {
        ...
        $(window).on("hashchange", function(n) {
          ...
          if ("/docTransMode" === e)
            B.currTask.file
              ? ($(".doc-trans-file").text(B.currTask.file.name),
                B.clearDocTransViewMode(),
                $("#main-outer").addClass("doc-trans-mode"),
                localStorage.getItem("docTransLangGuideFlag") ||
                  ($(".doc-trans-operation").addClass("guiding"),
                  $(".doc-trans-operation .doc-trans-dir").addClass("open")))
              : B.clearDocTrans();
            ...
            B.clearDocTrans(),
              t(
                "translation:widget/translate/input/autoRequest"
              ).onHashChange();
        }),
        D.on(
          "fileQueued",
                    ...
                    for (;;)
                      switch ((a.prev = a.next)) {
                        ...
                        case 15:
                          ...
                          (b.pasteCompatibility || b.dragCompatibility)
                            ? b.processImgFile(t.getSource().source)
                            : n(t),
                            D.removeFile(t, !0);
                        case 17:
                        case "end":
        ...
        $("#upload-btn").on("click", function() {
          Boolean(x.get("account").is_login)
            ? $("#upload-btn-hidden")
                .find('input[type="file"]')
                .click()
            : R.newLoginInstanceAsync(),
            window._hmt.push(["_trackEvent", "首页", "文档翻译_点击上传按钮"]);
        });
    });
  n.textareaInput = o;
});
define("translation:widget/translate/input/dataTransfer", function(t, e, n) {
  ...
  function a(t) {
        ...
        if ("file" === d) {
          ...
          if (m.startsWith("image/")) {
            ...
            y.logWrongFileFormat(g),
              alert(
                window.common.pdfHit
                  ? "目前仅支持 pdf、docx、doc、jpg、png、bmp、jpeg 格式哦"
                  : "目前仅支持 docx、doc、jpg、png、bmp、jpeg 格式哦"
              );
            break;
          }
        }
    ...
    if (i) {
      if (
        ...
        _hmt.push(
          "drop" === e
            ? ["_trackEvent", "首页", "53_首页页面_上传图片方式_拖拽"]
            : ["_trackEvent", "首页", "53_首页页面_上传图片方式_复制"]
        ),
        !u())
      )
        return h(o, !1), !1;
      ...
      return (
        t.preventDefault(),
        "drop" === e &&
          window._hmt.push(["_trackEvent", "首页", "文档翻译_拖入上传"]),
        E.addFiles(c),
        !1
      );
    return !0;
  ...
  function o(t) {
    return j
      .compress(t, { maxWidth: 1280, maxHeight: 1280, convertSize: 3e6 })
      .catch(function() {
      ...
      if (!r)
        return (
          _hmt.push([
            "_trackEvent",
            "首页",
            "57_首页页面_浏览器弹窗提示_上传文件暂不支持图片翻译"
          ]),
          void n(
            "上传文件暂不支持图片翻译，请上传bmp、jpg、jpeg或png格式的图片"
          )
        );
      var s = new Image(),
  ...
  function u() {
    var t = !1;
    return (
      F ? (t = !0) : Date.now() - U < I ? (t = !0) : (U = Date.now()),
      t &&
        (_hmt.push([
          "_trackEvent",
          "首页",
          "57_首页页面_浏览器弹窗提示_您的操作过于频繁 请稍候再试"
        ]),
  ...
  function p(t) {
    return D.includes(t) || "auto" === t
      ? !0
      : (alert("当前语言不支持图片识别，请选择语言"), w.fromBtnClicked(), !1);
  }
  function d(e, n) {
    if (
      (L.removeClass("with-loading-ocr-tip"),
      ...
      "auto" === n
        ? (r.showCustomPrompt(
          ...
          _hmt.push([
            "_trackEvent",
            "首页",
            "55_首页页面_输入框内提示_图片识别失败，请选择语言"
          ]))
        : (r.showCustomPrompt("图片识别失败，请重试"),
          _hmt.push([
            "_trackEvent",
            "首页",
            "55_首页页面_输入框内提示_图片识别失败，请重试"
          ]));
    } else {
      ...
      _hmt.push([
        "_trackEvent",
        "首页",
        "58_首页页面_对应语言上传图片的次数_" + i
      ]),
        u.translateAfterOcr(i, a);
    }
  }
  function m() {
    R.css("background-image", "none"),
      L.removeClass("with-image"),
      R.data("file", null);
  }
  function g() {
    return $(".trans-input-wrap").hasClass("with-image") &&
      $("#image-holder").data("file") &&
      !$("#baidu_translate_input").val()
      ? (h($("#image-holder").data("file"), !0), !1)
      : !0;
  }
  function f(t) {
    L.toggleClass("with-loading-ocr-tip", t),
  ...
  var h = (function() {
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    if (
                      (f(!0),
                      ("" === $("#baidu_translate_input").val() && r) ||
                        ((a = t("translation:widget/translate/input/events")),
                        a.onClearBtnClick()),
                      (u = $(".select-from-language .language-selected").attr(
                        "data-lang"
                      )),
                      (l = $(".select-to-language .language-selected").attr(
                        "data-lang"
                      )),
                      p(u))
                    ) {
    ...
    b = t("translation:widget/common/third_party/image-compressor"),
  ...
  !(function() {
    if ("1" === window.common.ocrHit) {
      ...
      t &&
        "function" == typeof t.createObjectURL &&
        !x.msie &&
        !x.ucbrowser &&
        window.FormData &&
        "undefined" != typeof window.FileReader &&
        ("draggable" in document.createElement("span") && (T = !0),
        x.check({ firefox: "41", chrome: "13", opera: "12.1" }, !0) &&
          (C = !0));
    }
  })(),
    (C || T) &&
      $(".upload-tip").text(
        window.common.pdfHit
          ? "点击上传文件，支持pdf、docx、doc、jpg等格式"
          : "点击上传文件，支持docx、doc、jpg等格式"
      );
  var S = L.find(".textarea-bg .prompt-text");
  window.common.docHit
    ? C
      ? (S.text("输入文字、网址 / 粘贴图片 / 拖入文档"),
        _hmt.push([
          "_trackEvent",
          "首页",
          "54_首页页面_输入框默认文案_输入文字、网址 / 粘贴图片 / 拖入文档"
        ]))
      : T
      ? (S.text("输入文字、网址 / 拖入图片、文档"),
        _hmt.push([
          "_trackEvent",
          "首页",
          "54_首页页面_输入框默认文案_输入文字、网址 / 拖入图片、文档"
        ]))
      : (S.text("输入文字、网址"),
        _hmt.push([
          "_trackEvent",
          "首页",
          "54_首页页面_输入框默认文案_输入文字、网址"
        ]))
    : C
    ? (S.text("输入文字、网址或粘贴图片 即可翻译"),
      _hmt.push([
        "_trackEvent",
        "首页",
        "54_首页页面_输入框默认文案_输入文字、网址或粘贴图片 即可翻译"
      ]))
    : T
    ? (S.text("输入文字、网址或拖拽图片 即可翻译"),
      _hmt.push([
        "_trackEvent",
        "首页",
        "54_首页页面_输入框默认文案_输入文字、网址或拖拽图片 即可翻译"
      ]))
    : (S.text("输入文字或网址 即可翻译"),
      _hmt.push([
        "_trackEvent",
        "首页",
        "54_首页页面_输入框默认文案_输入文字、网址 即可翻译"
      ])),
    (n.exports = {
      handle: a,
...
define("translation:widget/translate/input/dir", function(t, r) {
  ...
  r.changeDir = function(t) {
    t &&
      ($.inArray(t, a.get("rtl")) >= 0
        ? ($(".input-wrap").attr("dir", "rtl"),
          $(".textarea-clear-btn").css({ float: "left", margin: "0 10px 0 0" }))
    ...
    g = {
      fromBtnClicked: function() {
        $(".from-language-list").toggle(0, function() {
          "block" === $(".from-language-list").css("display")
            ? $(".select-from-language .arrow-down").addClass("lang-arrow-up")
            : "none" === $(".from-language-list").css("display") &&
              $(".select-from-language .arrow-down").removeClass(
                "lang-arrow-up"
              );
        });
      },
      ...
      fromlangItemSelect: function(e) {
        ...
        e.isDetected && (i = "检测到<span>" + i + "</span>"),
          $(".select-from-language .language-selected")
            .attr("data-lang", g)
            .html(i),
          "auto" === g
            ? this.autoItemSelected({ isDetected: e.isDetected })
            : this.normalItemSelected({ isDetected: e.isDetected }),
          l.changeDir(g),
      ...
      autoItemSelected: function(a) {
        ...
        var e = $(".from-to-exchange");
        e.hasClass("language-btn") &&
          e.removeClass("language-btn").addClass("language-btn-disable"),
          e.attr("aflag", 0);
      },
      normalItemSelected: function(a) {
        a.isDetected || t.set("fromLangIsAuto", !1);
        var e = $(".from-to-exchange");
        e.hasClass("language-btn-disable") &&
          e.removeClass("language-btn-disable").addClass("language-btn");
      }
    };
  ...
  var r = t("translation:widget/common/environment"),
    ...
    p = {
      ...
      showPrompt: function(t, n) {
        ...
        return r.get("fromLangIsAuto") && s
          ? (o.fromlangChange({ lang: t, isDetected: !0 }),
            void this.hidePrompt())
          : void (
              $(".trans-correct").is(":hidden") &&
              (n !== t && s ? this.renderPrompt(t, !1) : this.hidePrompt())
            );
      },
      renderPrompt: function(t, n) {
        var o = r.get("langList")[t],
          s = a("tplLangPrompt", { lang: t, langText: o, isOcr: n });
        $(".trans-prompt .prompt-wrap")
          .html(s)
          .parent()
          .show(),
      ...
      showCustomPrompt: function(t, n, r) {
        var o = '<span dir="ltr">';
        (o +=
          '<span class="prompt-text" style="margin-left: -42px;">' +
          t +
          "</span>"),
          n &&
            (o +=
              '<a href="javascript:" class="prompt-link' +
              (r ? " " + r : "") +
              '">' +
              n +
              "</a>"),
...
define("translation:widget/translate/input/correct", function(t, r) {
  ...
  "https:" === location.protocol &&
    (i = "https://correctxt.baidu.com/correctxt?callback=?");
  var s = {
    tpl: [
      '<span class="correct-text">您是不是要找:</span>',
      '<a href="###" class="correct-link correct-query">$${correctxt}</a>'
    ].join(""),
    ...
    setLastInput: function(t) {
      var r = this;
      return !this.isEnglishQuery(t) || t.length > 20
        ? void $(".trans-correct").hide()
        : (clearTimeout(e),
    ...
    return (
      ...
      this.each(function() {
        if ("selectionStart" in this)
          (this.selectionStart = t), (this.selectionEnd = e);
  ...
  var h = {
    ...
    resize: function() {
      ...
      (s = $("#baidu_translate_input")[0].scrollHeight),
        $("#baidu_translate_input")[0].scrollHeight &&
          parseInt($("#baidu_translate_input")[0].scrollHeight, 10) >= t &&
          (i.height($("#baidu_translate_input")[0].scrollHeight),
          e.height(i.height())),
        a.sameHeight();
    },
  ...
  (t.isSupport = (function() {
    try {
      return window.localStorage
        ? ((window.localStorage.isSupport = "true"), !0)
        : !1;
    } catch (r) {
      return !1;
    }
  ...
  var e = t("translation:widget/common/third_party/template"),
    ...
    d = {
      ...
      bindEvent: function() {
        var t = this;
        a
          .on("click", ".history-remove-all", function(i) {
            i.preventDefault(),
              i.stopPropagation(),
              r.deleteAllStorge(),
              t.renderHistory({ data: null }),
              _hmt.push(["_trackEvent", "首页", "Web点击历史记录清空按钮"]);
          })
          .on("click", ".history-edit-btn", function(t) {
            t.preventDefault(),
              t.stopPropagation(),
              a.addClass("history-editing");
          })
          .on("click", ".history-complete", function(t) {
            t.preventDefault(),
              t.stopPropagation(),
              a.removeClass("history-editing");
          })
          ...
          $(document).on("click.history", function(t) {
            var i = $(t.target);
            i.hasClass("history-wrap") ||
              i.parents(".history-wrap").length > 0 ||
              a.removeClass("history-editing");
          });
      },
      onInput: function() {
      ...
      renderHistory: function(t) {
        var i = t.data;
        if (
          (t.forceQuitEditingPattern && a.removeClass("history-editing"),
          i && i.data.length)
        ) {
          for (var n, o = i.data, r = i.len, h = [], d = r - 1; d >= 0; d--) {
            ...
            if (l instanceof Array) {
              n =
                "/#" +
                encodeURIComponent(l[2]) +
                "/" +
                encodeURIComponent(l[3]) +
                "/" +
        ...
        s.html(""),
          a
            .addClass("history-none")
            .removeClass("history-editing")
            .show();
      },
    ...
    a = {
      ...
      sendIndexLog: function() {
        ...
        a && (t.op_type = "ald" + a),
          ...
          r.testCookie() || e.sendIndexFeatureLog({ action: "nocookie" }),
          _hmt.push(["_trackEvent", "首页", "web端PV"]);
        var i = parseInt(a, 10);
        16047 === i
          ? _hmt.push(["_trackEvent", "首页", "web端泛需求阿拉丁导入PV"])
          : 85 === i
          ? _hmt.push(["_trackEvent", "首页", "web端词典阿拉丁导入PV"])
          : 23 === i &&
            _hmt.push(["_trackEvent", "首页", "web端翻译阿拉丁导入PV"]);
      },
    ...
    n = {
      checkfavor: function(t) {
        var e = this,
          ...
          n =
            ...
            "2" +
            $(".select-to-language .language-selected").attr("data-lang"),
          i = $.trim($("#baidu_translate_input").val()).replace(
            /<br( \/)?>/gi,
            "&lt;br$1&gt;"
          ),
          d = t.category,
          c = t.firstScreen || !1;
        "zonedword" === o &&
          ((n = $(".zonedword-wrap .zonedword-search-input").attr("data-dir")),
          (i = $.trim(
            $(".zonedword-wrap .zonedword-search-input").val()
          ).replace(/<br( \/)?>/gi, "&lt;br$1&gt;")));
        var l = {
          req: "check",
          fanyi_src: i,
        ...
        r || 0 !== d || "zonedword" === o
          ? r || 1 !== d || "zonedword" === o
            ? r || "zonedword" !== o || (r = $(".zonedword-wrap .op-favo")[0])
            : (r = $(".dictionary-wrap .op-favo")[0])
          : (r = $(".ordinary-wrap .op-favo")[0]),
          $.ajax({
            url: "/pccollection",
            type: "POST",
            data: l,
      ...
      favorIsSaved: function(t) {
        var e = (t.from, t.id),
          ...
          o = t.firstScreen || !1;
        o ||
          ($(a).attr("data-hover-tip-text", "已收藏"), r.isover({ target: a })),
          $(a)
            .attr({
              "favo-id": e,
      ...
      favorIsNotSaved: function(t) {
        var e = t.from,
          a = t.target;
        return "zonedword" == e
          ? void $(".zonedword-wrap .op-favo")
              .attr({ "favo-id": "" })
              .removeClass("op-favo-cur")
          : void $(a)
              .attr({ "favo-id": "", "data-hover-tip-text": "收藏结果" })
              .removeClass("op-favo-cur");
      },
      ...
      execAdd: function(t) {
        var e,
          ...
          o = $(a),
          n = t.from;
        o.hasClass("op-favo-cur")
          ? (this.deleteFavor({ id: o.attr("favo-id"), target: a }),
          ...
          : ("zonedword" === n
              ? _hmt.push(["_trackEvent", "首页", "web端划词翻译添加收藏"])
              : o.parents(".dictionary-wrap").length > 0
              ? ((e = 1),
                _hmt.push(["_trackEvent", "首页", "web端词典结果添加收藏"]))
              : ((e = 0),
                _hmt.push(["_trackEvent", "首页", "web端译文框添加收藏"])),
            this.realAdd({ target: a, from: n, category: e }));
      },
      realAdd: function(t) {
        var e,
          r = this,
        ...
        "zonedword" === n
          ? ((i = ""),
            ...
            $(".zonedword-result .dictionary-output").length > 0
              ? ((d = 1),
                (e = $(".zonedword-result .dictionary-output")),
                e.each(function() {
                  (i += $(this)
              ...
              : ((d = 0),
                ...
                (i = i
                  ...
                  .replace(/<br \/>/gi, "\r\n"))))
          : 1 === d
          ? ((e = $(".dictionary-wrap .dictionary-output")),
            e.each(function() {
              (i += $(this)
                .find(".dictionary-title")
                .html()),
            ...
            (i = i.replace(/&lt;/gim, "<")),
            (i = i.replace("详细释义>>", "")))
          : ((e = $(".output-wrap .output-bd").find(".target-output")),
            e.each(function() {
              i +=
                $(this)
                  .html()
        ...
        $.ajax("/pccollection", {
          ...
          success: function(t) {
            0 === t.error
              ? r.favorIsSaved({ id: t.id, from: n, target: o })
              : -6 === t.error;
          }
        });
      },
      deleteFavor: function(t) {
        var e = t.target,
          r =
            "/pccollection?req=del&id=" +
            t.id +
            "&datatype=json&signature=" +
            a.get("token");
        $.ajax({
          url: r,
          type: "get",
          ...
          success: function(t) {
            0 === t.error &&
              $(e)
                .removeClass("op-favo-cur")
                .attr("data-hover-tip-text", "已取消收藏");
          }
        });
      }
    };
...
define("translation:widget/translate/setting/setting", function(e) {
  ...
  var t = e("translation:widget/common/environment"),
    ...
    i = e("translation:widget/login/login"),
    o = e("translation:widget/translate/history/history"),
    n = {
      init: function() {
      ...
      initSetting: function() {
        try {
          "true" !== localStorage.getItem("PC2.10CollBtnTagClicked") &&
            $(".collection-btn").addClass("new-edition-tip");
        } catch (e) {}
        var i = s.getCookie("REALTIME_TRANS_SWITCH");
        i
          ? "0" === i
            ? ($(".realtrans-switch").removeClass("setting-checked"),
              t.set("isInRealtimeMode", !1))
            : t.set("isInRealtimeMode", !0)
          : i ||
            (s.setCookie("REALTIME_TRANS_SWITCH", 1, { expires: 864e8 }),
            t.set("isInRealtimeMode", !0));
        var o = s.getCookie("FANYI_WORD_SWITCH");
        o
          ? "0" === o
            ? ($(".zonedword-switch").removeClass("setting-checked"),
              t.set("isInFanyiWordMode", !1))
            : t.set("isInFanyiWordMode", !0)
          : o ||
            (s.setCookie("FANYI_WORD_SWITCH", 1, { expires: 864e8 }),
            t.set("isInFanyiWordMode", !0));
        var n = s.getCookie("HISTORY_SWITCH");
        n
          ? "0" === n
            ? ($(".history-switch").removeClass("setting-checked"),
              t.set("isInHistoryMode", !1))
            : "1" === n && t.set("isInHistoryMode", !0)
          : (s.setCookie("HISTORY_SWITCH", 1, { expires: 864e8 }),
            t.set("isInHistoryMode", !0));
        var d = s.getCookie("SOUND_SPD_SWITCH");
        d
          ? "0" === d
            ? ($("#spd-slow").addClass("sound-spd-radio-checked"),
              t.set("soundSpdMode", "slow"))
            : "2" === d
            ? ($("#spd-fast").addClass("sound-spd-radio-checked"),
              t.set("soundSpdMode", "fast"))
            : ($("#spd-normal").addClass("sound-spd-radio-checked"),
              t.set("soundSpdMode", "normal"))
          : (s.setCookie("SOUND_SPD_SWITCH", 1, { expires: 864e8 }),
            $("#spd-normal").addClass("sound-spd-radio-checked"),
            t.set("soundSpdMode", "normal"));
        var r = s.getCookie("SOUND_PREFER_SWITCH");
        r
          ? "0" === r
            ? ($("#prefer-uk").addClass("sound-prefer-radio-checked"),
              t.set("soundPreferMode", "uk"))
            : ($("#prefer-en").addClass("sound-prefer-radio-checked"),
              t.set("soundPreferMode", "en"))
          : (s.setCookie("SOUND_PREFER_SWITCH", 1, { expires: 864e8 }),
            $("#prefer-en").addClass("sound-prefer-radio-checked"),
            t.set("soundPreferMode", "en"));
      },
      bindEvents: function() {
        $(".setting-btn").on("click", $.proxy(this.settingBtnClick, this)),
          ...
          $(".realtrans-switch").on(
            "click",
            $.proxy(this.setRealtransSwitch, this)
          ),
          $(".translate-setting .zonedword-switch").on(
            "click",
            $.proxy(this.setZonedwordSwitch, this)
          ),
          $(".history-switch").on(
            "click",
            $.proxy(this.setHistorySwitch, this)
          ),
          $(".sound-spd-switch").on(
            "click",
            ".sound-spd-radio",
            $.proxy(this.soundSpdSwitch, this)
          ),
          $(".sound-prefer-switch").on(
            "click",
            ".sound-prefer-radio",
            $.proxy(this.soundPreferSwitch, this)
          );
      },
      ...
      documentClick: function(e) {
        var t = $(e.target);
        "block" === $(".setting-options").css("display") &&
          (t.hasClass("icon-setting") ||
            t.hasClass("setting-options") ||
            t.parents(".setting-options").length > 0 ||
            this.hideSettingTips());
      },
      collectionClick: function() {
        var e = t.get("account");
        if (
          (_hmt.push(["_trackEvent", "首页", "web端点击收藏夹"]),
          "" === e.is_login)
        )
          i.newLoginInstanceAsync();
        else {
      ...
      setRealtransSwitch: function() {
        ...
        var i;
        e.hasClass("setting-checked")
          ? (t.set("isInRealtimeMode", !0),
            (i = 1),
            _hmt.push(["_trackEvent", "首页", "web端实时翻译打开"]))
          : (t.set("isInRealtimeMode", !1),
            (i = 0),
            _hmt.push(["_trackEvent", "首页", "web端实时翻译关闭"])),
          s.setCookie("REALTIME_TRANS_SWITCH", i, { expires: 864e8 });
      },
      setZonedwordSwitch: function() {
        ...
        e.hasClass("setting-checked")
          ? ((i = 1),
            t.set("isInFanyiWordMode", !0),
            _hmt.push(["_trackEvent", "首页", "web端划词翻译打开"]))
          : ((i = 0),
            t.set("isInFanyiWordMode", !1),
            _hmt.push(["_trackEvent", "首页", "web端划词翻译关闭"])),
          s.setCookie("FANYI_WORD_SWITCH", i, { expires: 864e8 });
      },
      setHistorySwitch: function() {
        ...
        e.hasClass("setting-checked")
          ? ((i = 1),
            t.set("isInHistoryMode", !0),
            _hmt.push(["_trackEvent", "首页", "设置-历史记录-开启"]))
          : ((i = 0),
            t.set("isInHistoryMode", !1),
            _hmt.push(["_trackEvent", "首页", "设置-历史记录-关闭"])),
          o.onHistoryInput(),
          s.setCookie("HISTORY_SWITCH", i, { expires: 864e8 });
      },
      soundSpdSwitch: function(e) {
        var i = $(e.currentTarget);
        if (!i.hasClass("sound-spd-radio-checked")) {
          $(".sound-spd-switch .sound-spd-radio-checked").removeClass(
            "sound-spd-radio-checked"
          ),
            i.addClass("sound-spd-radio-checked");
          var o = i.attr("data-value");
          "slow" === o
            ? (s.setCookie("SOUND_SPD_SWITCH", 0, { expires: 864e8 }),
              _hmt.push(["_trackEvent", "首页", "设置-发音语速-较慢"]))
            : "normal" === o
            ? (s.setCookie("SOUND_SPD_SWITCH", 1, { expires: 864e8 }),
              _hmt.push(["_trackEvent", "首页", "设置-发音语速-中速"]))
            : (s.setCookie("SOUND_SPD_SWITCH", 2, { expires: 864e8 }),
              _hmt.push(["_trackEvent", "首页", "设置-发音语速-较快"])),
            t.set("soundSpdMode", o);
        }
      },
      soundPreferSwitch: function(e) {
        var i = $(e.currentTarget);
        if (!i.hasClass("sound-prefer-radio-checked")) {
          $(".sound-prefer-switch .sound-prefer-radio-checked").removeClass(
            "sound-prefer-radio-checked"
          ),
            i.addClass("sound-prefer-radio-checked");
          var o = i.attr("data-value");
          "en" === o
            ? (s.setCookie("SOUND_PREFER_SWITCH", 1, { expires: 864e8 }),
              _hmt.push(["_trackEvent", "首页", "设置-英语发音偏好-美式"]))
            : (s.setCookie("SOUND_PREFER_SWITCH", 0, { expires: 864e8 }),
              _hmt.push(["_trackEvent", "首页", "设置-英语发音偏好-英式"])),
            t.set("soundPreferMode", o);
        }
      }
    };
  $(function() {
  ...
  var n = t("translation:widget/common/environment"),
    ...
    i = {
      ...
      addOcrSupport: function() {
        ...
        t.each(function() {
          var t = $(this);
          n.get("ocrLangList").includes(t.attr("value")) &&
            t.addClass("support-ocr");
        });
      },
      bindEvents: function() {
        $(".trans-operation-wrapper")
          .on(
            "click",
            ".select-from-language",
            $.proxy(this.clickFromBtn, this)
          )
          .on("click", ".select-to-language", $.proxy(this.clickToBtn, this))
          .on(
            "click",
            ".from-to-exchange",
            $.proxy(this.clickExchangeBtn, this)
          )
          .on(
            "click",
            ".from-language-list .language-data a",
            $.proxy(this.clickFromItem, this)
          )
          .on(
            "click",
            ".to-language-list .language-data a",
            $.proxy(this.clickToItem, this)
          )
          .on(
            "click",
            ".from-language-list .language-often li a",
            $.proxy(this.clickFromOfen, this)
          )
          .on(
            "click",
            ".to-language-list .language-often li a",
            $.proxy(this.clickToOfen, this)
          ),
          $("#translate-button").on(
            "click",
            $.proxy(this.clickTranslate, this)
          ),
      ...
      clickFromItem: function(t) {
        a.fromlangItemSelect({ target: $(t.target), trans: !0 }),
          _hmt.push(["_trackEvent", "首页", "web端点击源语言列表item"]);
      },
      clickToItem: function(t) {
        e.tolangItemSelect({ target: $(t.target), trans: !0 }),
      ...
      clickBody: function(t) {
        var n = $(t.target);
        ("block" === $(".from-language-list").css("display") &&
          (n.hasClass("select-from-language") ||
            n.parents(".select-from-language").length > 0 ||
            n.hasClass("from-language-list") ||
            n.parents(".from-language-list").length > 0)) ||
          a.hideFromWrap(),
          ("block" === $(".to-language-list").css("display") &&
            (n.hasClass("select-to-language") ||
              n.parents(".select-to-language").length > 0 ||
              n.hasClass("to-language-list") ||
              n.parents(".to-language-list").length > 0)) ||
            e.hideToWrap();
      },
  ...
  var t = o("translation:widget/translate/zonedword/wordWrap"),
    ...
    d = {
      ...
      bindEvents: function() {
        var o = this;
        $(document)
          .on("mouseup", ".trans-input-wrap", this.zonedwordIsMouseUp)
          .on("mouseup", ".output-wrap", this.zonedwordIsMouseUp)
          .on("mouseup", "#left-result-container", this.zonedwordIsMouseUp)
          .on(
            "mousedown",
            ".trans-input-wrap",
            $.proxy(this.zonedwordIsMouseDown, this)
          )
          .on(
            "mousedown",
            ".output-wrap",
          ...
          .on("click", $.proxy(this.documentIsClick, this)),
          $(window).on("resize", this.zonedwordIsHide),
          $("#zonedword-wrap")
            .on("click", ".zonedword-close", this.onCloseZonedword)
            .on("click", ".zonedword-setting-icon", this.toggleZoneWordOption)
            .on("click", ".zonedword-switch", this.switchZoneword)
            .on("click", ".zonedword-detail-link", this.onClickMore)
            .on("click", ".op-sound", function() {
              o.onClickSound({ target: this });
            })
            .on("mouseenter", ".op-sound", function() {
              o.onSoundMouseOver({ target: this });
            })
            .on("mouseleave", ".op-sound", $.proxy(this.onSoundMouseOut, this))
            .on("click", function(o) {
              var t = $(o.target);
              t.hasClass("setting-options") ||
                t.parents(".setting-options").length > 0 ||
                $("#zonedword-wrap .setting-options").hide();
            }),
          this.bindDrag();
      },
      ...
      documentIsClick: function(o) {
        var n = $(o.target);
        n.parents("#zonedword-wrap").length > 0 ||
          ($("#zonedword-wrap .setting-options").hide(), t.hideWrap());
      },
      ...
      switchZoneword: function(o) {
        ...
        var n;
        t.hasClass("setting-checked")
          ? ((n = 1), r.set("isInFanyiWordMode", !0))
          : ((n = 0),
          ...
          s.setCookie("FANYI_WORD_SWITCH", n, { expires: 864e8 });
      },
      onClickSound: function(o) {
        ...
        t.addClass("op-sound-active"),
          ...
          "keywords" === r.get("zonewordQueryFrom") &&
            _hmt.push([
              "_trackEvent",
              "首页",
              "Web重点词汇卡片highlight出划词翻译框发音按钮的发音次数"
            ]);
      },
...
define("translation:widget/footer/banner/banner", function(n, t) {
  ...
  function r() {
    $(document)
      .delegate(".spread-slide", "click", function(n) {
...
define("translation:widget/footer/extra/extra", function(n, t) {
  ...
  function o() {
    var n = $(".manual-spread");
    return n.length > 0 && !n.hasClass("manual-spread-none")
      ? void a.css("top", 0.7 * $(window).height())
      : void a.css("top", 0.7 * $(window).height()).show();
  }
  function i() {
...
define("translation:widget/footer/follow/follow", function(o, t) {
  ...
  function a(o) {
    var t = o.target;
    return t === this || t === $("#fdialog-close").get(0)
      ? ($("#follow-dialog").addClass("hide"), o.stopPropagation(), !1)
      : void 0;
  }
  t.init = function() {
    i();
...
define("translation:widget/footer/footer", function(i) {
  ...
  var n = i("translation:widget/translate/input/dataTransfer"),
    ...
    r = {
      ...
      bindEvent: function() {
        $(window)
          .on("resize", this.documentIsChange)
          .on("hashchange", this.documentIsChange);
      },
      documentIsChange: function() {
        var i = void 0;
        if (
          (!n.dragCompatibility && !n.pasteCompatibility) ||
          o.is(":hidden") ||
          (i = o.offset().top + o.height() + s) < e.height() + h
        ) {
